...
Unread
        ...
        <ul className="nav nav-phoenix-pills mb-5 d-sm-none d-xl-flex" id="contactListTab" data-chat-thread-tab role="tablist">
          <li className="nav-item" role="presentation">
            <a href="#" className="nav-link cursor-pointer active" data-bs-toggle={"tab"} data-chat-thread-list={"all"} role="tab" aria-selected="true">
All
            </a>
          </li>
          <li className="nav-item" role="presentation">
            <a href="#" className="nav-link cursor-pointer" data-bs-toggle={"tab"} role="tab" data-chat-thread-list={"read"} aria-selected="false">
Read
            </a>
          </li>
          <li className="nav-item" role="presentation">
            <a href="#" className="nav-link cursor-pointer" data-bs-toggle={"tab"} role="tab" data-chat-thread-list={"unread"} aria-selected="false">
Unread
            </a>
          </li>
        </ul>
            ...
            <div data-chat-thread-tab-content>
              <ul className="nav chat-thread-tab flex-column list">
                <li className="nav-item read" role="presentation">
                  <a href="#tab-thread-1" className="nav-link d-flex align-items-center justify-content-center p-2  active" data-bs-toggle={"tab"} data-chat-thread  role="tab" aria-selected="true">
                    <div className="avatar avatar-xl status-online position-relative me-2 me-sm-0 me-xl-2">
                      <PhoenixImage src="/assets/img/team/20.webp" alt="" className="rounded-circle border border-2 border-light-subtle" />
                    </div>                    <div className="flex-1 d-sm-none d-xl-block">
...
This is a message from you
                ...
                <li className="nav-item read" role="presentation">
                  <a href="#tab-thread-2" className="nav-link d-flex align-items-center justify-content-center p-2  " data-bs-toggle={"tab"} data-chat-thread  role="tab" aria-selected="true">
                    <div className="avatar avatar-xl status-online position-relative me-2 me-sm-0 me-xl-2">
                      <PhoenixImage src="/assets/img/team/29.webp" alt="" className="rounded-circle border border-2 border-light-subtle" />
                    </div>                    <div className="flex-1 d-sm-none d-xl-block">
                      <div className="d-flex justify-content-between align-items-center">
                        <h5 className="text-body fw-normal name text-nowrap">
Urito Nisemuno
...
Say Hi to your new friend now
                ...
                <li className="nav-item read" role="presentation">
                  <a href="#tab-thread-3" className="nav-link d-flex align-items-center justify-content-center p-2  " data-bs-toggle={"tab"} data-chat-thread  role="tab" aria-selected="true">
                    <div className="avatar avatar-xl status-online position-relative me-2 me-sm-0 me-xl-2">
                      <PhoenixImage src="/assets/img/team/30.webp" alt="" className="rounded-circle border border-2 border-light-subtle" />
                    </div>                    <div className="flex-1 d-sm-none d-xl-block">
                      <div className="d-flex justify-content-between align-items-center">
                        <h5 className="text-body fw-normal name text-nowrap">
Xiang Ledepisipang
...
We can also discuss prese....
                ...
                <li className="nav-item unread" role="presentation">
                  <a href="#tab-thread-4" className="nav-link d-flex align-items-center justify-content-center p-2 unread " data-bs-toggle={"tab"} data-chat-thread  role="tab" aria-selected="true">
                    <div className="avatar avatar-xl status-online position-relative me-2 me-sm-0 me-xl-2">
                      <PhoenixImage src="/assets/img/team/25.webp" alt="" className="rounded-circle border border-2 border-light-subtle" />
                      <span className="bg-primary rounded-circle top-0 end-0 position-absolute text-white d-flex flex-center fs-10 fw-semibold d-none d-sm-flex d-xl-none lh-1" style={{"height":"1rem","width":"1rem"} as CSSProperties}>
3
                      </span>
                    </div>                    <div className="flex-1 d-sm-none d-xl-block">
                      <div className="d-flex justify-content-between align-items-center">
...
3+
                ...
                <li className="nav-item read" role="presentation">
                  <a href="#tab-thread-5" className="nav-link d-flex align-items-center justify-content-center p-2  " data-bs-toggle={"tab"} data-chat-thread  role="tab" aria-selected="true">
                    <div className="avatar avatar-xl status-online position-relative me-2 me-sm-0 me-xl-2">
                      <PhoenixImage src="/assets/img/team/15.webp" alt="" className="rounded-circle border border-2 border-light-subtle" />
                    </div>                    <div className="flex-1 d-sm-none d-xl-block">
                      <div className="d-flex justify-content-between align-items-center">
                        <h5 className="text-body fw-normal name text-nowrap">
Nenko Nimitanip
...
Nenko sent an attachment
                ...
                <li className="nav-item unread" role="presentation">
                  <a href="#tab-thread-6" className="nav-link d-flex align-items-center justify-content-center p-2 unread " data-bs-toggle={"tab"} data-chat-thread  role="tab" aria-selected="true">
                    <div className="avatar avatar-xl status-online position-relative me-2 me-sm-0 me-xl-2">
                      <PhoenixImage src="/assets/img/team/59.webp" alt="" className="rounded-circle border border-2 border-light-subtle" />
                    </div>                    <div className="flex-1 d-sm-none d-xl-block">
                      <div className="d-flex justify-content-between align-items-center">
                        <h5 className="text-body fw-normal name text-nowrap">
Shanito Bistroglini
...
https://youtu.be/dQw4w9WgXcQ
                ...
                <li className="nav-item read" role="presentation">
                  <a href="#tab-thread-7" className="nav-link d-flex align-items-center justify-content-center p-2  " data-bs-toggle={"tab"} data-chat-thread  role="tab" aria-selected="true">
                    <div className="avatar avatar-xl status-online position-relative me-2 me-sm-0 me-xl-2">
                      <PhoenixImage src="/assets/img/team/avatar.webp" alt="" className="rounded-circle border border-2 border-light-subtle avatar-placeholder" />
                    </div>                    <div className="flex-1 d-sm-none d-xl-block">
                      <div className="d-flex justify-content-between align-items-center">
                        <h5 className="text-body fw-normal name text-nowrap">
Misthoni Trepalnano
...
You shared an album
                ...
                <li className="nav-item read" role="presentation">
                  <a href="#tab-thread-8" className="nav-link d-flex align-items-center justify-content-center p-2  " data-bs-toggle={"tab"} data-chat-thread  role="tab" aria-selected="true">
                    <div className="avatar avatar-xl status-online position-relative me-2 me-sm-0 me-xl-2">
                      <PhoenixImage src="/assets/img/team/1.webp" alt="" className="rounded-circle border border-2 border-light-subtle" />
                    </div>                    <div className="flex-1 d-sm-none d-xl-block">
                      <div className="d-flex justify-content-between align-items-center">
                        <h5 className="text-body fw-normal name text-nowrap">
Zogidi Lishang
...
Reacted ❤️ to your photo
                ...
                <li className="nav-item read" role="presentation">
                  <a href="#tab-thread-9" className="nav-link d-flex align-items-center justify-content-center p-2  " data-bs-toggle={"tab"} data-chat-thread  role="tab" aria-selected="true">
                    <div className="avatar avatar-xl status-online position-relative me-2 me-sm-0 me-xl-2">
                      <PhoenixImage src="/assets/img/team/6.webp" alt="" className="rounded-circle border border-2 border-light-subtle" />
                    </div>                    <div className="flex-1 d-sm-none d-xl-block">
                      <div className="d-flex justify-content-between align-items-center">
                        <h5 className="text-body fw-normal name text-nowrap">
Nonteporano Lepat
...
Thanks for understanding. I will forever be in debt
                ...
                <li className="nav-item read" role="presentation">
                  <a href="#tab-thread-10" className="nav-link d-flex align-items-center justify-content-center p-2  " data-bs-toggle={"tab"} data-chat-thread  role="tab" aria-selected="true">
                    <div className="avatar avatar-xl status-online position-relative me-2 me-sm-0 me-xl-2">
                      <PhoenixImage src="/assets/img/team/60.webp" alt="" className="rounded-circle border border-2 border-light-subtle" />
                    </div>                    <div className="flex-1 d-sm-none d-xl-block">
                      <div className="d-flex justify-content-between align-items-center">
                        <h5 className="text-body fw-normal name text-nowrap">
Jessica Ball
...
Thanks for understanding. I will forever be in debt
                ...
                <li className="nav-item read" role="presentation">
                  <a href="#tab-thread-11" className="nav-link d-flex align-items-center justify-content-center p-2  " data-bs-toggle={"tab"} data-chat-thread  role="tab" aria-selected="true">
                    <div className="avatar avatar-xl status-online position-relative me-2 me-sm-0 me-xl-2">
                      <PhoenixImage src="/assets/img/team/57.webp" alt="" className="rounded-circle border border-2 border-light-subtle" />
                    </div>                    <div className="flex-1 d-sm-none d-xl-block">
                      <div className="d-flex justify-content-between align-items-center">
                        <h5 className="text-body fw-normal name text-nowrap">
Harley Brown
...
Yes, in an organization stature
                          ...
                          <PhoenixLink href="/assets/img/chat/1.png" data-gallery={"gallery-undefined"}>
                            <PhoenixImage src="/assets/img/chat/1.png" alt="" className="rounded-2 object-fit-cover mt-1" />
                          </PhoenixLink>
                        </div>
                      </div>
                    </div>
...
Yesterday, 10 AM
            ...
            <div className="card-footer">
              ...
              <div className="d-flex justify-content-between align-items-end">
                <div>
                  <button className="btn btn-link py-0 ps-0 pe-2 text-body fs-9 btn-emoji" data-picmo>
...
Shared Media
                    ...
                    <div className="row g-2">
                      <div className="col-auto">
                        <PhoenixLink href="/assets/img/chat/2.png" data-gallery={"gallery"}>
                          <PhoenixImage src="/assets/img/chat/2.png" alt="" className="object-fit-cover rounded-2 bg-body-secondary-hover" width={100} height={100} />
                        </PhoenixLink>
                      </div>
                      <div className="col-auto">
                        <PhoenixLink href="/assets/img/chat/3.png" data-gallery={"gallery"}>
                          <PhoenixImage src="/assets/img/chat/3.png" alt="" className="object-fit-cover rounded-2 bg-body-secondary-hover" width={100} height={100} />
                        </PhoenixLink>
                      </div>
                      <div className="col-auto">
                        <PhoenixLink href="/assets/img/chat/4.png" data-gallery={"gallery"}>
                          <PhoenixImage src="/assets/img/chat/4.png" alt="" className="object-fit-cover rounded-2 bg-body-secondary-hover" width={100} height={100} />
                        </PhoenixLink>
                      </div>
                      <div className="col-auto">
                        <PhoenixLink href="/assets/img/chat/5.png" data-gallery={"gallery"}>
                          <PhoenixImage src="/assets/img/chat/5.png" alt="" className="object-fit-cover rounded-2 bg-body-secondary-hover" width={100} height={100} />
                        </PhoenixLink>
                      </div>
                      <div className="col-auto">
                        <PhoenixLink href="/assets/img/chat/6.png" data-gallery={"gallery"}>
                          <PhoenixImage src="/assets/img/chat/6.png" alt="" className="object-fit-cover rounded-2 bg-body-secondary-hover" width={100} height={100} />
                        </PhoenixLink>
                      </div>
                      <div className="col-auto">
                        <PhoenixLink href="/assets/img/chat/7.png" data-gallery={"gallery"}>
                          <PhoenixImage src="/assets/img/chat/7.png" alt="" className="object-fit-cover rounded-2 bg-body-secondary-hover" width={100} height={100} />
                        </PhoenixLink>
                      </div>
                      <div className="col-auto">
                        <PhoenixLink href="/assets/img/chat/8.png" data-gallery={"gallery"}>
                          <PhoenixImage src="/assets/img/chat/8.png" alt="" className="object-fit-cover rounded-2 bg-body-secondary-hover" width={100} height={100} />
                        </PhoenixLink>
                      </div>
                      <div className="col-auto">
                        <PhoenixLink href="/assets/img/chat/9.png" data-gallery={"gallery"}>
                          <PhoenixImage src="/assets/img/chat/9.png" alt="" className="object-fit-cover rounded-2 bg-body-secondary-hover" width={100} height={100} />
                        </PhoenixLink>
                      </div>
                      <div className="col-auto">
                        <PhoenixLink href="/assets/img/chat/10.png" data-gallery={"gallery"}>
                          <PhoenixImage src="/assets/img/chat/10.png" alt="" className="object-fit-cover rounded-2 bg-body-secondary-hover" width={100} height={100} />
                        </PhoenixLink>
                      </div>
                      <div className="col-auto">
                        <PhoenixLink href="/assets/img/chat/11.png" data-gallery={"gallery"}>
                          <PhoenixImage src="/assets/img/chat/11.png" alt="" className="object-fit-cover rounded-2 bg-body-secondary-hover" width={100} height={100} />
                        </PhoenixLink>
                      </div>
                      <div className="col-auto">
                        <PhoenixLink href="/assets/img/chat/12.png" data-gallery={"gallery"}>
                          <PhoenixImage src="/assets/img/chat/12.png" alt="" className="object-fit-cover rounded-2 bg-body-secondary-hover" width={100} height={100} />
                        </PhoenixLink>
                      </div>
                      <div className="col-auto">
                        <PhoenixLink href="/assets/img/chat/13.png" data-gallery={"gallery"}>
                          <PhoenixImage src="/assets/img/chat/13.png" alt="" className="object-fit-cover rounded-2 bg-body-secondary-hover" width={100} height={100} />
                        </PhoenixLink>
                      </div>
                      <div className="col-auto">
                        <PhoenixLink href="/assets/img/chat/14.png" data-gallery={"gallery"}>
                          <PhoenixImage src="/assets/img/chat/14.png" alt="" className="object-fit-cover rounded-2 bg-body-secondary-hover" width={100} height={100} />
                        </PhoenixLink>
                      </div>
                      <div className="col-auto">
                        <PhoenixLink href="/assets/img/chat/2.png" data-gallery={"gallery"}>
...
Shared Files
                      ...
                      <div className="mb-2">
                        <div className="border-bottom border-translucent d-flex align-items-center justify-content-between">
                          <a href="#!" className="text-decoration-none d-flex align-items-center py-3">
...
Dec 2, 2011
                      ...
                      <a href="#!" className="btn btn-link fs-10 p-0">
See 19 more                         <span className="fa-solid fa-chevron-down ms-1">                        </span>
                      </a>
                    </div>
                  </div>
                </div>
                        ...
                        <div className="mb-1 sent-message-content gallery" data-bs-theme={"light"}>
                          ...
                          <div className="row g-2 mt-0">
                            <div className="col-6 col-md-4 ol-xl-2 col-xl-3">
                              <PhoenixLink href="/assets/img/chat/13.png" data-gallery={"gallery-undefined"}>
                                <PhoenixImage src="/assets/img/chat/13.png" alt="" className="rounded-2 object-fit-cover img-fluid" />
                              </PhoenixLink>
                            </div>
                            <div className="col-6 col-md-4 ol-xl-2 col-xl-3">
                              <PhoenixLink href="/assets/img/chat/2.png" data-gallery={"gallery-undefined"}>
                                <PhoenixImage src="/assets/img/chat/2.png" alt="" className="rounded-2 object-fit-cover img-fluid" />
                              </PhoenixLink>
                            </div>
                            <div className="col-6 col-md-4 ol-xl-2 col-xl-3">
                              <PhoenixLink href="/assets/img/chat/3.png" data-gallery={"gallery-undefined"}>
                                <PhoenixImage src="/assets/img/chat/3.png" alt="" className="rounded-2 object-fit-cover img-fluid" />
                              </PhoenixLink>
                            </div>
                            <div className="col-6 col-md-4 ol-xl-2 col-xl-3">
                              <PhoenixLink href="/assets/img/chat/4.png" data-gallery={"gallery-undefined"}>
                                <PhoenixImage src="/assets/img/chat/4.png" alt="" className="rounded-2 object-fit-cover img-fluid" />
                              </PhoenixLink>
                            </div>
                            <div className="col-6 col-md-4 ol-xl-2 col-xl-3">
                              <PhoenixLink href="/assets/img/chat/5.png" data-gallery={"gallery-undefined"}>
                                <PhoenixImage src="/assets/img/chat/5.png" alt="" className="rounded-2 object-fit-cover img-fluid" />
                              </PhoenixLink>
                            </div>
                            <div className="col-6 col-md-4 ol-xl-2 col-xl-3">
                              <PhoenixLink href="/assets/img/chat/6.png" data-gallery={"gallery-undefined"}>
                                <PhoenixImage src="/assets/img/chat/6.png" alt="" className="rounded-2 object-fit-cover img-fluid" />
                              </PhoenixLink>
                            </div>
                            <div className="col-6 col-md-4 ol-xl-2 col-xl-3">
                              <PhoenixLink href="/assets/img/chat/7.png" data-gallery={"gallery-undefined"}>
                                <PhoenixImage src="/assets/img/chat/7.png" alt="" className="rounded-2 object-fit-cover img-fluid" />
                              </PhoenixLink>
                            </div>
                            <div className="col-6 col-md-4 ol-xl-2 col-xl-3">
                              <PhoenixLink href="/assets/img/chat/8.png" data-gallery={"gallery-undefined"}>
                                <PhoenixImage src="/assets/img/chat/8.png" alt="" className="rounded-2 object-fit-cover img-fluid" />
                              </PhoenixLink>
                            </div>
                            <div className="col-6 col-md-4 ol-xl-2 col-xl-3">
                              <PhoenixLink href="/assets/img/chat/9.png" data-gallery={"gallery-undefined"}>
                                <PhoenixImage src="/assets/img/chat/9.png" alt="" className="rounded-2 object-fit-cover img-fluid" />
                              </PhoenixLink>
                            </div>
                            <div className="col-6 col-md-4 ol-xl-2 col-xl-3">
                              <PhoenixLink href="/assets/img/chat/10.png" data-gallery={"gallery-undefined"}>
                                <PhoenixImage src="/assets/img/chat/10.png" alt="" className="rounded-2 object-fit-cover img-fluid" />
                              </PhoenixLink>
                            </div>
                            <div className="col-6 col-md-4 ol-xl-2 col-xl-3">
                              <PhoenixLink href="/assets/img/chat/11.png" data-gallery={"gallery-undefined"}>
                                <PhoenixImage src="/assets/img/chat/11.png" alt="" className="rounded-2 object-fit-cover img-fluid" />
                              </PhoenixLink>
                            </div>
                            <div className="col-6 col-md-4 ol-xl-2 col-xl-3">
                              <PhoenixLink href="/assets/img/chat/12.png" data-gallery={"gallery-undefined"}>
                                <PhoenixImage src="/assets/img/chat/12.png" alt="" className="rounded-2 object-fit-cover img-fluid" />
                              </PhoenixLink>
                            </div>
                          </div>
                        </div>
...
Block Account
      ...
      <div className="modal fade" id="chatSearchBoxModal" tabIndex={-1} aria-hidden="true" data-bs-backdrop={"true"} data-phoenix-modal style={{"--phoenix-backdrop-opacity":"1"} as CSSProperties}>
        <div className="modal-dialog">
          <div className="modal-content mt-15">
            <div className="modal-body p-0">
              <div className="chat-search-box">
                <div className="form-icon-container">
                  <input className="form-control py-3 form-icon-input rounded-1" type="text" autoFocus placeholder="Search People, Groups and Messages" />
