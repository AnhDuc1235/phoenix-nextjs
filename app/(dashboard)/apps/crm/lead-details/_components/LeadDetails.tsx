            ...
            <div className="col-12 col-md-auto">
              <div className="d-flex">
                <div className="flex-1 d-md-none">
                  <button className="btn px-3 btn-phoenix-secondary text-body-tertiary me-2" data-phoenix-toggle={"offcanvas"} data-phoenix-target={"#productFilterColumn"}>
...
Send an email
                ...
                <button className="btn btn-phoenix-secondary px-3 px-sm-5 me-2">
                  <span className="fa-solid fa-thumbtack me-sm-2">                  </span>
      ...
      <div className="row g-0 g-md-4 g-xl-6">
        <div className="col-md-5 col-lg-5 col-xl-4">
          <div className="sticky-leads-sidebar">
            <div className="lead-details-offcanvas bg-body scrollbar phoenix-offcanvas phoenix-offcanvas-fixed" id="productFilterColumn" data-breakpoint={"md"}>
...
Edit
                  ...
                  <div className="mb-4">
                    <div className="d-flex align-items-center mb-1">
                      <span className="me-2 uil uil-estate">                      </span>
                      <h5 className="mb-0">
Street
                      </h5>
                    </div>
...
38/2 Penelope street
                  ...
                  <div className="mb-4">
                    <div className="d-flex align-items-center mb-1">
                      <span className="me-2 uil uil-map-pin-alt">                      </span>
...
1425
                  ...
                  <div className="mb-4">
                    <div className="d-flex align-items-center mb-1">
                      <span className="me-2 uil uil-map">                      </span>
                      <h5 className="mb-0 text-body-highlight">
City
                      </h5>
                    </div>
...
Qualimando
                  ...
                  <div>
                    <div className="d-flex align-items-center mb-1">
                      <span className="me-2 uil uil-windsock">                      </span>
                      <h5 className="mb-0 text-body-highlight">
Country
                      </h5>
                    </div>
...
United Empire of Brekania
        ...
        <div className="col-md-7 col-lg-7 col-xl-8">
          <div className="lead-details-container">
            <nav className="navbar pb-4 px-0 sticky-top bg-body nav-underline-scrollspy" id="navbar-deals-detail">
              <ul className="nav nav-underline fs-9">
                <li className="nav-item">
                  <a href="#scrollspyTask" className="nav-link me-2">
Tasks
                  </a>
                </li>
                <li className="nav-item">
                  <a href="#scrollspyDeals" className="nav-link me-2">
Deals
                  </a>
                </li>
                <li className="nav-item">
                  <a href="#scrollspyEmails" className="nav-link me-2">
Emails
                  </a>
                </li>
                <li className="nav-item">
                  <a href="#scrollspyAttachments" className="nav-link">
Attachments 
                  </a>
                </li>
              </ul>
            </nav>
            <div className="scrollspy-example rounded-2" data-bs-spy={"scroll"} data-bs-offset={"0"} data-bs-target={"#navbar-deals-detail"} data-bs-root-margin={"0px 0px -40%"} data-bs-smooth-scroll={"true"} tabIndex={0}>
              <div className="mb-8">
...
Add Deals
                ...
                <div className="border-top border-bottom border-translucent" id="leadDetailsTable" data-list={"{\"valueNames\":[\"dealName\",\"amount\",\"stage\",\"probability\",\"date\",\"type\"],\"page\":5,\"pagination\":true}"}>
                    ...
                    <table className="table fs-9 mb-0">
                      <thead>
                        <tr>
                          ...
                          <th className="sort white-space-nowrap align-middle pe-3 ps-0 text-uppercase" scope="col" data-sort={"dealName"} style={{"width":"15%","minWidth":"200px"} as CSSProperties}>
Deal name
                          </th>
                          <th className="sort align-middle pe-6 text-uppercase text-end" scope="col" data-sort={"amount"} style={{"width":"15%","minWidth":"100px"} as CSSProperties}>
Amount
                          </th>
                          <th className="sort align-middle text-start text-uppercase" scope="col" data-sort={"stage"} style={{"width":"20%","minWidth":"200px"} as CSSProperties}>
Stage
                          </th>
                          <th className="sort align-middle text-start text-uppercase" scope="col" data-sort={"probability"} style={{"width":"20%","minWidth":"100px"} as CSSProperties}>
Probability
                          </th>
                          <th className="sort align-middle ps-0 text-end text-uppercase" scope="col" data-sort={"date"} style={{"width":"15%","minWidth":"120px"} as CSSProperties}>
Closing Date
                          </th>
                          <th className="sort align-middle text-end text-uppercase" scope="col" data-sort={"type"} style={{"width":"15%","minWidth":"140px"} as CSSProperties}>
Type
                          </th>
                      ...
                      <tbody className="list" id="lead-details-table-body"><tr className="hover-actions-trigger btn-reveal-trigger position-static">
                          <td className="fs-9 align-middle px-0 py-3">
                            <div className="form-check mb-0 fs-8">
                              <input className="form-check-input" type="checkbox" data-bulk-select-row={"{\"dealName\":\"Mocking Bird\",\"active\":true,\"amount\":\"$6,800,000\",\"stage_status\":{\"label\":\"won deal\",\"type\":\"badge-phoenix-success\"},\"progress\":{\"min\":\"67\",\"max\":\"145\",\"color\":\"bg-info\"},\"date\":\"Dec 29, 2021\",\"type_status\":{\"label\":\"warm\",\"type\":\"badge-phoenix-info\"}}"} />
                            </div>
                          </td>
...
67%
                            ...
                            <div className="progress bg-primary-subtle" style={{"height":"3px"} as CSSProperties} role="progressbar">
                              <div className="progress-bar bg-info" style={{"width":"46.206896551724135%"} as CSSProperties} role="progressbar" aria-valuenow={25} aria-valuemin={0} aria-valuemax={100}>                              </div>
                            </div>
                          </td>
...
Remove
                        ...
                        <tr className="hover-actions-trigger btn-reveal-trigger position-static"><td className="fs-9 align-middle px-0 py-3">
                            <div className="form-check mb-0 fs-8">
                              <input className="form-check-input" type="checkbox" data-bulk-select-row={"{\"dealName\":\"Airbender\",\"active\":true,\"amount\":\"$89,090,000\",\"stage_status\":{\"label\":\"new Deal\",\"type\":\"badge-phoenix-primary\"},\"progress\":{\"min\":\"34\",\"max\":\"145\",\"color\":\"bg-warning\"},\"date\":\"Mar 27, 2021\",\"type_status\":{\"label\":\"hot\",\"type\":\"badge-phoenix-danger\"}}"} />
                            </div>
                          </td>
                          <td className="dealName align-middle white-space-nowrap py-2 ps-0">
                            <a href="#!" className="fw-semibold text-primary">
...
34%
                            ...
                            <div className="progress bg-primary-subtle" style={{"height":"3px"} as CSSProperties} role="progressbar">
                              <div className="progress-bar bg-warning" style={{"width":"23.448275862068964%"} as CSSProperties} role="progressbar" aria-valuenow={25} aria-valuemin={0} aria-valuemax={100}>                              </div>
                            </div>
                          </td>
                          <td className="date align-middle text-body-tertiary text-center py-2">
Mar 27, 2021
...
Remove
                        ...
                        <tr className="hover-actions-trigger btn-reveal-trigger position-static"><td className="fs-9 align-middle px-0 py-3">
                            <div className="form-check mb-0 fs-8">
                              <input className="form-check-input" type="checkbox" data-bulk-select-row={"{\"dealName\":\"Showmen\",\"active\":true,\"amount\":\"$78,650,000\",\"stage_status\":{\"label\":\"Canceled\",\"type\":\"badge-phoenix-secondary\"},\"progress\":{\"min\":\"89\",\"max\":\"145\",\"color\":\"bg-success\"},\"date\":\"Jun 24, 2021\",\"type_status\":{\"label\":\"cold\",\"type\":\"badge-phoenix-warning\"}}"} />
                            </div>
                          </td>
                          <td className="dealName align-middle white-space-nowrap py-2 ps-0">
                            <a href="#!" className="fw-semibold text-primary">
...
89%
                            ...
                            <div className="progress bg-primary-subtle" style={{"height":"3px"} as CSSProperties} role="progressbar">
                              <div className="progress-bar bg-success" style={{"width":"61.37931034482759%"} as CSSProperties} role="progressbar" aria-valuenow={25} aria-valuemin={0} aria-valuemax={100}>                              </div>
                            </div>
                          </td>
                          <td className="date align-middle text-body-tertiary text-center py-2">
Jun 24, 2021
...
Remove
                        ...
                        <tr className="hover-actions-trigger btn-reveal-trigger position-static"><td className="fs-9 align-middle px-0 py-3">
                            <div className="form-check mb-0 fs-8">
                              <input className="form-check-input" type="checkbox" data-bulk-select-row={"{\"dealName\":\"Tarakihi\",\"active\":true,\"amount\":\"$1,200,000\",\"stage_status\":{\"label\":\"In Progress\",\"type\":\"badge-phoenix-info\"},\"progress\":{\"min\":\"90\",\"max\":\"145\",\"color\":\"bg-success\"},\"date\":\"May 19, 2024\",\"type_status\":{\"label\":\"hot\",\"type\":\"badge-phoenix-danger\"}}"} />
                            </div>
                          </td>
                          <td className="dealName align-middle white-space-nowrap py-2 ps-0">
                            <a href="#!" className="fw-semibold text-primary">
...
90%
                            ...
                            <div className="progress bg-primary-subtle" style={{"height":"3px"} as CSSProperties} role="progressbar">
                              <div className="progress-bar bg-success" style={{"width":"62.06896551724138%"} as CSSProperties} role="progressbar" aria-valuenow={25} aria-valuemin={0} aria-valuemax={100}>                              </div>
                            </div>
                          </td>
                          <td className="date align-middle text-body-tertiary text-center py-2">
May 19, 2024
...
Remove
                        ...
                        <tr className="hover-actions-trigger btn-reveal-trigger position-static"><td className="fs-9 align-middle px-0 py-3">
                            <div className="form-check mb-0 fs-8">
                              <input className="form-check-input" type="checkbox" data-bulk-select-row={"{\"dealName\":\"Ponce d’leon\",\"active\":true,\"amount\":\"$46,000\",\"stage_status\":{\"label\":\"won Deal\",\"type\":\"badge-phoenix-success\"},\"progress\":{\"min\":\"97\",\"max\":\"145\",\"color\":\"bg-success\"},\"date\":\"Aug 19, 2024\",\"type_status\":{\"label\":\"cold\",\"type\":\"badge-phoenix-warning\"}}"} />
                            </div>
                          </td>
                          <td className="dealName align-middle white-space-nowrap py-2 ps-0">
                            <a href="#!" className="fw-semibold text-primary">
...
97%
                            ...
                            <div className="progress bg-primary-subtle" style={{"height":"3px"} as CSSProperties} role="progressbar">
                              <div className="progress-bar bg-success" style={{"width":"66.89655172413794%"} as CSSProperties} role="progressbar" aria-valuenow={25} aria-valuemin={0} aria-valuemax={100}>                              </div>
                            </div>
                          </td>
                          <td className="date align-middle text-body-tertiary text-center py-2">
Aug 19, 2024
...
Remove
                        ...
                        <tr className="hover-actions-trigger btn-reveal-trigger position-static"><td className="fs-9 align-middle px-0 py-3">
                            <div className="form-check mb-0 fs-8">
                              <input className="form-check-input" type="checkbox" data-bulk-select-row={"{\"dealName\":\"leon\",\"active\":true,\"amount\":\"$66,000\",\"stage_status\":{\"label\":\"IN PROGRESS\",\"type\":\"badge-phoenix-info\"},\"progress\":{\"min\":\"88\",\"max\":\"145\",\"color\":\"bg-success\"},\"date\":\"Aug 19, 2024\",\"type_status\":{\"label\":\"cold\",\"type\":\"badge-phoenix-warning\"}}"} />
                            </div>
                          </td>
                          <td className="dealName align-middle white-space-nowrap py-2 ps-0">
                            <a href="#!" className="fw-semibold text-primary">
...
88%
                            ...
                            <div className="progress bg-primary-subtle" style={{"height":"3px"} as CSSProperties} role="progressbar">
                              <div className="progress-bar bg-success" style={{"width":"60.689655172413794%"} as CSSProperties} role="progressbar" aria-valuenow={25} aria-valuemin={0} aria-valuemax={100}>                              </div>
                            </div>
                          </td>
                          <td className="date align-middle text-body-tertiary text-center py-2">
Aug 19, 2024
