...
Filter
                        ...
                        <div className="modal-body pt-4 pb-2 px-4">
                          <div className="mb-3">
                            <label className="fw-bold mb-2 text-body-highlight" htmlFor="priority">
Priority
                            </label>
...
Choose a time period
                          ...
                          <div className="mb-3">
                            <label className="fw-bold mb-2 text-body-highlight" htmlFor="category">
Category
                            </label>
                            <select className="form-select" id="category">
                              <option value="salesReports">
Sales Reports
                              </option>
                              <option value="hrReports">
HR Reports
                              </option>
                ...
                <div className="border-bottom border-translucent">
                  <div className="d-flex align-items-start mb-1">
                    ...
                    <div className="d-sm-flex align-items-center ps-2">
                      <PhoenixLink href="/apps/crm/report-details" className="fw-bold fs-7 lh-sm title line-clamp-1 me-sm-4">
...
Purchasing-Related Vendors
                ...
                <div className="row g-1 g-sm-3 mt-2 lh-1">
                  <div className="col-12 col-sm-auto flex-1 text-truncate">
                    <a href="#!" className="fw-semibold fs-9">
                      <span className="fa-regular fa-folder me-2 reportsby">                      </span>Reports by email
                    </a>
                  </div>
...
Based on the percentage of recipients
                ...
                <div className="row g-1 g-sm-3 mt-2 lh-1">
                  <div className="col-12 col-sm-auto flex-1 text-truncate">
                    <a href="#!" className="fw-semibold fs-9">
                      <span className="fa-regular fa-folder me-2 reportsby">                      </span>Reports on Sales Orders
                    </a>
                  </div>
                  <div className="col-12 col-sm-auto">
                    <div className="d-flex align-items-center">
...
Sales for Today
                ...
                <div className="row g-1 g-sm-3 mt-2 lh-1">
                  <div className="col-12 col-sm-auto flex-1 text-truncate">
                    <a href="#!" className="fw-semibold fs-9">
                      <span className="fa-regular fa-folder me-2 reportsby">                      </span>Reviews of Products
                    </a>
                  </div>
                  <div className="col-12 col-sm-auto">
                    <div className="d-flex align-items-center">
...
Emails sent by users to all records,
                ...
                <div className="row g-1 g-sm-3 mt-2 lh-1">
                  <div className="col-12 col-sm-auto flex-1 text-truncate">
                    <a href="#!" className="fw-semibold fs-9">
                      <span className="fa-regular fa-folder me-2 reportsby">                      </span>Reports on Deals
                    </a>
                  </div>
                  <div className="col-12 col-sm-auto">
                    <div className="d-flex align-items-center">
