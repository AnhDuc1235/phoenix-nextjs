          ...
          <div className="row g-3">
            <div className="col-auto">
              <button className="btn btn-phoenix-danger">
                <span className="fa-solid fa-trash-can me-2">                </span>
Delete customer
              </button>
            </div>
            <div className="col-auto">
            ...
            <div className="border-top border-bottom border-translucent" id="customerOrdersTable" data-list={"{\"valueNames\":[\"order\",\"total\",\"payment_status\",\"fulfilment_status\",\"delivery_type\",\"date\"],\"page\":6,\"pagination\":true}"}>
              <div className="table-responsive scrollbar">
                <table className="table table-sm fs-9 mb-0">
                  <thead>
                    <tr>
                      <th className="sort white-space-nowrap align-middle ps-0 pe-3" scope="col" data-sort={"order"} style={{"width":"10%"} as CSSProperties}>
ORDER
                      </th>
                      <th className="sort align-middle text-end pe-7" scope="col" data-sort={"total"} style={{"width":"10%"} as CSSProperties}>
TOTAL
                      </th>
                      <th className="sort align-middle white-space-nowrap pe-3" scope="col" data-sort={"payment_status"} style={{"width":"15%"} as CSSProperties}>
PAYMENT STATUS
                      </th>
                      <th className="sort align-middle white-space-nowrap text-start pe-3" scope="col" data-sort={"fulfilment_status"} style={{"width":"20%"} as CSSProperties}>
FULFILMENT STATUS
                      </th>
                      <th className="sort align-middle white-space-nowrap text-start" scope="col" data-sort={"delivery_type"} style={{"width":"30%"} as CSSProperties}>
DELIVERY TYPE
                      </th>
                      <th className="sort align-middle text-end pe-0" scope="col" data-sort={"date"}>
DATE
                      </th>
                      <th className="sort text-end align-middle pe-0 ps-5" scope="col">                      </th>
                    </tr>
                  </thead>
                  <tbody className="list" id="customer-order-table-body"><tr className="hover-actions-trigger btn-reveal-trigger position-static">
...
Remove
                    ...
                    <tr className="hover-actions-trigger btn-reveal-trigger position-static"><td className="order align-middle white-space-nowrap ps-0">
                        <a href="#!" className="fw-semibold">
#2452
                        </a>
                      </td>
...
Failed
                          ...
                          <span className="ms-1" data-feather={"minus-circle"} style={{"height":"12.8px","width":"12.8px"} as CSSProperties}>                          </span>
                        </span>
                      </td>
                      <td className="fulfilment_status align-middle white-space-nowrap text-start fw-bold text-body-tertiary">
                        <span className="badge badge-phoenix fs-10 badge-phoenix-danger">
            ...
            <div className="border-translucent border-top border-bottom" id="customerWishlistTable" data-list={"{\"valueNames\":[\"products\",\"color\",\"size\",\"price\",\"quantity\",\"total\"],\"page\":5,\"pagination\":true}"}>
              <div className="table-responsive scrollbar">
                <table className="table fs-9 mb-0">
                  <thead>
                    <tr>
                      <th className="sort white-space-nowrap align-middle fs-10" scope="col" style={{"width":"5%"} as CSSProperties}>                      </th>
                      <th className="sort white-space-nowrap align-middle" scope="col" style={{"width":"35%","minWidth":"250px"} as CSSProperties} data-sort={"products"}>
PRODUCTS
                      </th>
                      <th className="sort align-middle" scope="col" data-sort={"color"} style={{"width":"15%"} as CSSProperties}>
COLOR
                      </th>
                      <th className="sort align-middle" scope="col" data-sort={"size"} style={{"width":"10%"} as CSSProperties}>
SIZE
                      </th>
                      <th className="sort align-middle text-end" scope="col" data-sort={"price"} style={{"width":"15%"} as CSSProperties}>
PRICE
                      </th>
                      <th className="sort align-middle text-end" scope="col" data-sort={"total"} style={{"width":"15%"} as CSSProperties}>
TOTAL
                      </th>
                    </tr>
                  </thead>
                  <tbody className="list" id="customer-wishlist-table-body"><tr className="hover-actions-trigger btn-reveal-trigger position-static">
                      <td className="align-middle white-space-nowrap py-1">
                        <PhoenixLink href="/apps/e-commerce/landing/product-details" className="border border-translucent rounded-2 d-inline-block">
                          <PhoenixImage src="/assets/img/products/1.png" alt="" width={40} height={40} />
                        </PhoenixLink>
                      </td>
                      <td className="products align-middle">
                        <PhoenixLink href="/apps/e-commerce/landing/product-details" className="fw-semibold mb-0">
...
$57
                    ...
                    <tr className="hover-actions-trigger btn-reveal-trigger position-static"><td className="align-middle white-space-nowrap py-1">
                        <PhoenixLink href="/apps/e-commerce/landing/product-details" className="border border-translucent rounded-2 d-inline-block">
                          <PhoenixImage src="/assets/img/products/7.png" alt="" width={40} height={40} />
                        </PhoenixLink>
                      </td>
                      <td className="products align-middle">
                        <PhoenixLink href="/apps/e-commerce/landing/product-details" className="fw-semibold mb-0">
2021 Apple 12.9-inch iPad Pro (Wi‑Fi, ...
                        </PhoenixLink>
                      </td>
                      <td className="color align-middle white-space-nowrap fs-9 text-body">
Black
...
$1499
                    ...
                    <tr className="hover-actions-trigger btn-reveal-trigger position-static"><td className="align-middle white-space-nowrap py-1">
                        <PhoenixLink href="/apps/e-commerce/landing/product-details" className="border border-translucent rounded-2 d-inline-block">
                          <PhoenixImage src="/assets/img/products/6.png" alt="" width={40} height={40} />
                        </PhoenixLink>
                      </td>
                      <td className="products align-middle">
                        <PhoenixLink href="/apps/e-commerce/landing/product-details" className="fw-semibold mb-0">
...
$359
                    ...
                    <tr className="hover-actions-trigger btn-reveal-trigger position-static"><td className="align-middle white-space-nowrap py-1">
                        <PhoenixLink href="/apps/e-commerce/landing/product-details" className="border border-translucent rounded-2 d-inline-block">
                          <PhoenixImage src="/assets/img/products/3.png" alt="" width={40} height={40} />
                        </PhoenixLink>
                      </td>
                      <td className="products align-middle">
                        <PhoenixLink href="/apps/e-commerce/landing/product-details" className="fw-semibold mb-0">
...
$1,799
                    ...
                    <tr className="hover-actions-trigger btn-reveal-trigger position-static"><td className="align-middle white-space-nowrap py-1">
                        <PhoenixLink href="/apps/e-commerce/landing/product-details" className="border border-translucent rounded-2 d-inline-block">
                          <PhoenixImage src="/assets/img/products/4.png" alt="" width={40} height={40} />
                        </PhoenixLink>
                      </td>
                      <td className="products align-middle">
                        <PhoenixLink href="/apps/e-commerce/landing/product-details" className="fw-semibold mb-0">
...
$65
                    ...
                    <tr className="hover-actions-trigger btn-reveal-trigger position-static"><td className="align-middle white-space-nowrap py-1">
                        <PhoenixLink href="/apps/e-commerce/landing/product-details" className="border border-translucent rounded-2 d-inline-block">
                          <PhoenixImage src="/assets/img/products/10.png" alt="" width={40} height={40} />
                        </PhoenixLink>
                      </td>
                      <td className="products align-middle">
                        <PhoenixLink href="/apps/e-commerce/landing/product-details" className="fw-semibold mb-0">
...
$60
                    ...
                    <tr className="hover-actions-trigger btn-reveal-trigger position-static"><td className="align-middle white-space-nowrap py-1">
                        <PhoenixLink href="/apps/e-commerce/landing/product-details" className="border border-translucent rounded-2 d-inline-block">
                          <PhoenixImage src="/assets/img/products/8.png" alt="" width={40} height={40} />
                        </PhoenixLink>
                      </td>
                      <td className="products align-middle">
                        <PhoenixLink href="/apps/e-commerce/landing/product-details" className="fw-semibold mb-0">
...
$40
                    ...
                    <tr className="hover-actions-trigger btn-reveal-trigger position-static"><td className="align-middle white-space-nowrap py-1">
                        <PhoenixLink href="/apps/e-commerce/landing/product-details" className="border border-translucent rounded-2 d-inline-block">
                          <PhoenixImage src="/assets/img/products/12.png" alt="" width={40} height={40} />
                        </PhoenixLink>
                      </td>
                      <td className="products align-middle">
                        <PhoenixLink href="/apps/e-commerce/landing/product-details" className="fw-semibold mb-0">
...
$130
                    ...
                    <tr className="hover-actions-trigger btn-reveal-trigger position-static"><td className="align-middle white-space-nowrap py-1">
                        <PhoenixLink href="/apps/e-commerce/landing/product-details" className="border border-translucent rounded-2 d-inline-block">
                          <PhoenixImage src="/assets/img/products/17.png" alt="" width={40} height={40} />
                        </PhoenixLink>
                      </td>
                      <td className="products align-middle">
                        <PhoenixLink href="/apps/e-commerce/landing/product-details" className="fw-semibold mb-0">
            ...
            <div className="border-top border-bottom border-translucent" id="customerRatingsTable" data-list={"{\"valueNames\":[\"product\",\"rating\",\"review\",\"status\",\"date\"],\"page\":5,\"pagination\":true}"}>
              <div className="table-responsive scrollbar">
                <table className="table fs-9 mb-0">
                  <thead>
                    <tr>
                      <th className="sort white-space-nowrap align-middle ps-0" scope="col" style={{"width":"20%"} as CSSProperties} data-sort={"product"}>
PRODUCT
                      </th>
                      <th className="sort align-middle" scope="col" data-sort={"rating"} style={{"width":"10%"} as CSSProperties}>
RATING
                      </th>
                      <th className="sort align-middle" scope="col" style={{"width":"50%"} as CSSProperties} data-sort={"review"}>
REVIEW
                      </th>
                      <th className="sort text-end align-middle" scope="col" style={{"width":"10%"} as CSSProperties} data-sort={"status"}>
STATUS
                      </th>
                      <th className="sort text-end align-middle" scope="col" style={{"width":"10%"} as CSSProperties} data-sort={"date"}>
DATE
                      </th>
                      <th className="sort text-end pe-0 align-middle" scope="col">                      </th>
                    </tr>
                  </thead>
                  <tbody className="list" id="customer-rating-table-body"><tr className="hover-actions-trigger btn-reveal-trigger position-static">
...
Remove
                    ...
                    <tr className="hover-actions-trigger btn-reveal-trigger position-static"><td className="align-middle product white-space-nowrap">
                        <PhoenixLink href="/apps/e-commerce/landing/product-details" className="fw-semibold">
Fitbit Sense Advanced Smartwatch ...
                      ...
                      <td className="align-middle review" style={{"minWidth":"350px"} as CSSProperties}>
                        <p className="fw-semibold text-body-highlight mb-0">
This is an exceptional smartwatch, featuring a wealth of useful functions at an affordable price. The watch is small ...
                          <a href="#!">
See more
                          </a>
                        </p>
...
HORI Racing Wheel Apex for PlaySt...
                      ...
                      <td className="align-middle review" style={{"minWidth":"350px"} as CSSProperties}>
                        <p className="fw-semibold text-body-highlight mb-0">
This steering wheel is a great buy! It works well and feels good, however I wish it had a wider diameter like a real ...
                          <a href="#!">
See more
                          </a>
                        </p>
...
iPhone 13 pro max-Pacific Blue-12...
                      ...
                      <td className="align-middle review" style={{"minWidth":"350px"} as CSSProperties}>
                        <p className="fw-semibold text-body-highlight mb-0">
I chose wisely. The phone is in excellent condition, with no scratches or dents, excellent battery life, and flawless...
                          <a href="#!">
See more
                          </a>
                        </p>
...
Apple iMac 24" 4K Retina Display ...
                      ...
                      <td className="align-middle review" style={{"minWidth":"350px"} as CSSProperties}>
                        <p className="fw-semibold text-body-highlight mb-0">
The best experience we could hope for. Customer service team is amazing and the quality of their products is unsurpas...
                          <a href="#!">
See more
                          </a>
                        </p>
