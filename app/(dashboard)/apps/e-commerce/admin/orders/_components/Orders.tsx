            ...
            <div className="col-auto">
              <div className="search-box">
                <form className="position-relative">
                  <input className="form-control search-input search" type="search" placeholder="Search orders" aria-label="Search" />
                ...
                <tr>
                  <th className="white-space-nowrap fs-9 align-middle ps-0" style={{"width":"26px"} as CSSProperties}>
                    <div className="form-check mb-0 fs-8">
                      <input className="form-check-input" id="checkbox-bulk-order-select" type="checkbox" data-bulk-select={"{\"body\":\"order-table-body\"}"} />
                    </div>
                  </th>
                  <th className="sort white-space-nowrap align-middle pe-3" scope="col" data-sort={"order"} style={{"width":"5%"} as CSSProperties}>
ORDER
                  </th>
                  <th className="sort align-middle text-end" scope="col" data-sort={"total"} style={{"width":"6%"} as CSSProperties}>
TOTAL
                  </th>
                  <th className="sort align-middle ps-8" scope="col" data-sort={"customer"} style={{"width":"28%","minWidth":"250px"} as CSSProperties}>
CUSTOMER
                  </th>
                  <th className="sort align-middle pe-3" scope="col" data-sort={"payment_status"} style={{"width":"10%"} as CSSProperties}>
PAYMENT STATUS
                  </th>
                  <th className="sort align-middle text-start pe-3" scope="col" data-sort={"fulfilment_status"} style={{"width":"12%","minWidth":"200px"} as CSSProperties}>
FULFILMENT STATUS
                  </th>
                  <th className="sort align-middle text-start" scope="col" data-sort={"delivery_type"} style={{"width":"30%"} as CSSProperties}>
DELIVERY TYPE
                  </th>
...
DATE
              ...
              <tbody className="list" id="order-table-body"><tr className="hover-actions-trigger btn-reveal-trigger position-static">
                  <td className="fs-9 align-middle px-0 py-3">
                    <div className="form-check mb-0 fs-8">
                      <input className="form-check-input" type="checkbox" data-bulk-select-row={"{\"order\":2453,\"total\":87,\"customer\":{\"avatar\":\"/team/32.webp\",\"name\":\"Carry Anna\"},\"payment_status\":{\"label\":\"Complete\",\"type\":\"badge-phoenix-success\",\"icon\":\"check\"},\"fulfilment_status\":{\"label\":\"Cancelled\",\"type\":\"badge-phoenix-secondary\",\"icon\":\"x\"},\"delivery_type\":\"Cash on delivery\",\"date\":\"Dec 12, 12:56 PM\"}"} />
                    </div>
                  </td>
...
Dec 9, 2:28PM
                ...
                <tr className="hover-actions-trigger btn-reveal-trigger position-static"><td className="fs-9 align-middle px-0 py-3">
                    <div className="form-check mb-0 fs-8">
                      <input className="form-check-input" type="checkbox" data-bulk-select-row={"{\"order\":2451,\"total\":375,\"customer\":{\"avatar\":\"/team/35.webp\",\"name\":\"Stanly Drinkwater\"},\"payment_status\":{\"label\":\"Pending\",\"type\":\"badge-phoenix-warning\",\"icon\":\"clock\"},\"fulfilment_status\":{\"label\":\"Completed\",\"type\":\"badge-phoenix-success\",\"icon\":\"check\"},\"delivery_type\":\"Local pickup\",\"date\":\"Dec 4, 12:56 PM\"}"} />
                    </div>
                  </td>
                  <td className="order align-middle white-space-nowrap py-0">
                    <a href="#!" className="fw-semibold">
...
Dec 1, 4:07 AM
                ...
                <tr className="hover-actions-trigger btn-reveal-trigger position-static"><td className="fs-9 align-middle px-0 py-3">
                    <div className="form-check mb-0 fs-8">
                      <input className="form-check-input" type="checkbox" data-bulk-select-row={"{\"order\":2449,\"total\":9562,\"customer\":{\"avatar\":\"/team/58.webp\",\"name\":\"Igor Borvibson\"},\"payment_status\":{\"label\":\"Failed\",\"type\":\"badge-phoenix-danger\",\"icon\":\"x\"},\"fulfilment_status\":{\"label\":\"Partially Fulfiled\",\"type\":\"badge-phoenix-success\",\"icon\":\"check\"},\"delivery_type\":\"Express\",\"date\":\"Nov 28, 7:28 PM\"}"} />
                    </div>
                  </td>
                  <td className="order align-middle white-space-nowrap py-0">
                    <a href="#!" className="fw-semibold">
...
Nov 24, 10:16 AM
                ...
                <tr className="hover-actions-trigger btn-reveal-trigger position-static"><td className="fs-9 align-middle px-0 py-3">
                    <div className="form-check mb-0 fs-8">
                      <input className="form-check-input" type="checkbox" data-bulk-select-row={"{\"order\":2447,\"total\":953,\"customer\":{\"avatar\":\"\",\"name\":\"Roy Anderson\"},\"payment_status\":{\"label\":\"Pending\",\"type\":\"badge-phoenix-warning\",\"icon\":\"clock\"},\"fulfilment_status\":{\"label\":\"Fulfiled\",\"type\":\"badge-phoenix-success\",\"icon\":\"check\"},\"delivery_type\":\"Cash on delivery\",\"date\":\"Nov 18, 5:43 PM\"}"} />
                    </div>
                  </td>
                  <td className="order align-middle white-space-nowrap py-0">
                    <a href="#!" className="fw-semibold">
...
Nov 18, 5:43 PM
                ...
                <tr className="hover-actions-trigger btn-reveal-trigger position-static"><td className="fs-9 align-middle px-0 py-3">
                    <div className="form-check mb-0 fs-8">
                      <input className="form-check-input" type="checkbox" data-bulk-select-row={"{\"order\":2446,\"total\":12,\"customer\":{\"avatar\":\"/team/31.webp\",\"name\":\"Martina scorcese\"},\"payment_status\":{\"label\":\"Pending\",\"type\":\"badge-phoenix-warning\",\"icon\":\"clock\"},\"fulfilment_status\":{\"label\":\"Fulfiled\",\"type\":\"badge-phoenix-success\",\"icon\":\"check\"},\"delivery_type\":\"Standard shipping\",\"date\":\"Nov 18, 2:09 AM\"}"} />
                    </div>
                  </td>
                  <td className="order align-middle white-space-nowrap py-0">
                    <a href="#!" className="fw-semibold">
...
Nov 05, 4:35 PM
                ...
                <tr className="hover-actions-trigger btn-reveal-trigger position-static"><td className="fs-9 align-middle px-0 py-3">
                    <div className="form-check mb-0 fs-8">
                      <input className="form-check-input" type="checkbox" data-bulk-select-row={"{\"order\":2442,\"total\":542,\"customer\":{\"avatar\":\"/team/3.webp\",\"name\":\"Emma Watson\"},\"payment_status\":{\"label\":\"Pending\",\"type\":\"badge-phoenix-warning\",\"icon\":\"clock\"},\"fulfilment_status\":{\"label\":\"Fulfiled\",\"type\":\"badge-phoenix-success\",\"icon\":\"check\"},\"delivery_type\":\"Standard shipping\",\"date\":\"Nov 05, 12:00 PM\"}"} />
                    </div>
                  </td>
                  <td className="order align-middle white-space-nowrap py-0">
                    <a href="#!" className="fw-semibold">
...
Oct 30, 4:25 PM
                ...
                <tr className="hover-actions-trigger btn-reveal-trigger position-static"><td className="fs-9 align-middle px-0 py-3">
                    <div className="form-check mb-0 fs-8">
                      <input className="form-check-input" type="checkbox" data-bulk-select-row={"{\"order\":2439,\"total\":999,\"customer\":{\"avatar\":\"/team/32.webp\",\"name\":\"Raymond Mims\"},\"payment_status\":{\"label\":\"Pending\",\"type\":\"badge-phoenix-warning\",\"icon\":\"clock\"},\"fulfilment_status\":{\"label\":\"Fulfiled\",\"type\":\"badge-phoenix-success\",\"icon\":\"check\"},\"delivery_type\":\"Cash on delivery\",\"date\":\"Oct 28, 3:00 PM\"}"} />
                    </div>
                  </td>
                  <td className="order align-middle white-space-nowrap py-0">
                    <a href="#!" className="fw-semibold">
