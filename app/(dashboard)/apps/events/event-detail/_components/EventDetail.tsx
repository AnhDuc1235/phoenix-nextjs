...
Event details
      ...
      <PhoenixImage src="/assets/img/generic/34.png" alt="" className="rounded w-100 object-fit-cover mb-5 mb-md-6 mb-xl-8" />
...
The ID number will be unique to all members, so it’s requested that you don’t share it with anyone. Any damage regarding a misused ID will not be ours to compensate or refund.Enjoy!
          ...
          <div className="row g-1 g-sm-2 mb-7 mb-xxl-8">
            <div className="col-3">
              <PhoenixLink href="/assets/img/gallery/19.jpg" data-gallery={"gallery-posts-undefined"}>
                <PhoenixImage src="/assets/img/gallery/19.jpg" alt="..." className="rounded h-100 w-100 object-fit-cover" />
              </PhoenixLink>
            </div>
            <div className="col-3">
              <PhoenixLink href="/assets/img/gallery/20.jpg" data-gallery={"gallery-posts-undefined"}>
                <PhoenixImage src="/assets/img/gallery/20.jpg" alt="..." className="rounded h-100 w-100 object-fit-cover" />
              </PhoenixLink>
            </div>
            <div className="col-6">
              <PhoenixLink href="/assets/img/gallery/21.jpg" data-gallery={"gallery-posts-undefined"}>
                <PhoenixImage src="/assets/img/gallery/21.jpg" alt="..." className="rounded h-100 w-100 object-fit-cover" />
              </PhoenixLink>
            </div>
          </div>
...
Organized by
          ...
          <div className="row g-2 mb-6 align-items-center">
            <div className="col-auto">
              <PhoenixImage src="/assets/img/brand2/b.png" alt="..." className="rounded img-fluid" width={40} height={40} />
            </div>
            <div className="col-sm-auto flex-1">
              <a href="#!" className="mb-0 text-primary fw-semibold lh-sm">
Bass Events, Inc.
              </a>
            </div>
...
Location 
            ...
            <div className="googlemap mb-3 mb-xl-4 location-map border" data-googlemap data-gmap data-latlng={"40.7228022,-74.0020158"} data-scrollwheel={"false"} data-zoom={"15"}>
