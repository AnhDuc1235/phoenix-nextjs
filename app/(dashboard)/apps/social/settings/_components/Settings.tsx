      ...
      <div className="row g-6">
        <div className="col-12 col-xl-4">
          <div className="card mb-5">
            <div className="card-header hover-actions-trigger position-relative mb-6" style={{"minHeight":"130px"} as CSSProperties}>
              ...
              <label className="avatar avatar-4xl status-online feed-avatar-profile cursor-pointer" htmlFor="upload-settings-porfile-picture">
                <PhoenixImage src="/assets/img/team/20.webp" alt="" className="rounded-circle img-thumbnail shadow-sm border-0" width={200} />
              </label>
            </div>
...
Who will be able to see your profile?
            ...
            <div className="form-check">
              <input className="form-check-input" id="onlyMe" type="radio" defaultChecked name="profiileVisibility" />
...
Who can tag you?
            ...
            <div className="form-check">
              <input className="form-check-input" id="tagGroupMembers" type="radio" defaultChecked name="tagPermission" />
...
Allow users to show your experiences
            ...
            <div className="form-check">
              <input className="form-check-input" id="showFollowers" type="checkbox" defaultChecked name="showFollowers" />
...
Allow users to show your followers
          ...
          <div className="mb-4">
            <div className="form-check form-switch">
              <input className="form-check-input" id="showPhone" type="checkbox" defaultChecked name="showPhone" />
              <label className="form-check-label fs-8" htmlFor="showPhone">
Show your phone number
              </label>
            </div>
            <div className="form-check form-switch">
              <input className="form-check-input" id="permitFollow" type="checkbox" defaultChecked name="permitFollow" />
...
ENTER YOUR PHONE
                ...
                <div className="col-12 col-sm-6">
                  <div className="form-icon-container">
                    <div className="form-floating">
                      <textarea className="form-control form-icon-input" id="info" style={{"height":"115px"} as CSSProperties} placeholder="Info" defaultValue="" />
