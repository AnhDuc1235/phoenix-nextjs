...
Use these shorthand utilities for quickly configuring how content overflows an element.
    ...
    <a href="https://getbootstrap.com/docs/5.3/utilities/overflow/" className="btn btn-link p-0"  target="_blank">
Overflow on Bootstrap      <span className="ms-1" data-feather={"chevron-right"}>      </span>
    </a>
    ...
    <div className="mt-4">
      <div className="row g-4">
        <div className="col-12 col-xl-10 order-1 order-xl-0">
          <div className="mb-9">
            <div className="card shadow-none border my-5 overflow-docs overflow-hidden" data-component-card style={{"minHeight":"250px"} as CSSProperties}>
...
{"<code class=\"language-html\"><div class=\\\"d-flex\\\"> <div class=\\\"overflow-auto\\\">This is an example of using <code>.overflow-auto </code>on an element with set width and height dimensions. By design, this content will vertically scroll.</div> <div class=\\\"overflow-hidden\\\">This is an example of using <code>.overflow-auto </code>on an element with set width and height dimensions. By design, this content will vertically scroll.</div> <div class=\\\"overflow-visible\\\">This is an example of using <code>.overflow-visible </code>on an element with set width and height dimensions. By design, this content will vertically scroll.</div> <div class=\\\"overflow-scroll\\\">This is an example of using <code>.overflow-scroll </code>on an element with set width and height dimensions. By design, this content will vertically scroll.</div> </div></code>"}
                  </pre>
                </div>
