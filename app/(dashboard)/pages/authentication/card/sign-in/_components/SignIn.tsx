...
Remember me
                      ...
                      <div className="col-auto">
                        <PhoenixLink href="/pages/authentication/card/forgot-password" className="fs-9 fw-semibold">
Forgot Password?
                        </PhoenixLink>
                      </div>
                    </div>
...
Sign In
                    ...
                    <div className="text-center">
                      <PhoenixLink href="/pages/authentication/card/sign-up" className="fs-9 fw-bold">
Create an account
                      </PhoenixLink>
                    </div>
                  </div>
