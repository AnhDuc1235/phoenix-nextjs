  ...
  return (
    ...
    <div className="row vh-100 g-0">
      <div className="col-lg-6 position-relative d-none d-lg-block">
        <div className="bg-holder" style={{"backgroundImage":"url(../../../assets/img/bg/40.png)"} as CSSProperties}>        </div>
      </div>
...
An email containing a 6-digit verification code has been sent to the email address - exa*********.com 
              </p>
...
Use another method
              ...
              <form className="verification-form" data-2fa-form>
                <div className="d-flex align-items-center gap-2 mb-3">
                  <input className="form-control px-2 text-center" type="number" />
                  <input className="form-control px-2 text-center" type="number" />
                  <input className="form-control px-2 text-center" type="number" />
                  <span>
-
                ...
                <div className="form-check text-start mb-4">
                  <input className="form-check-input" id="2fa-checkbox" type="checkbox" />
                  <label htmlFor="2fa-checkbox">
Don’t ask again on this device
                  </label>
                </div>
                <button className="btn btn-primary w-100 mb-5" type="submit" disabled>
Verify
                </button>
                <a href="#!" className="fs-9">
