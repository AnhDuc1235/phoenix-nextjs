  ...
  return (
    ...
    <div className="row vh-100 g-0">
      <div className="col-lg-6 position-relative d-none d-lg-block">
        <div className="bg-holder" style={{"backgroundImage":"url(../../../assets/img/bg/33.png)"} as CSSProperties}>        </div>
      </div>
...
Enter your password to access the admin
            ...
            <div className="position-relative" data-password>
              <input className="form-control mb-3" id="password" type="password" placeholder="Enter Password" data-password-input />
            ...
            <PhoenixLink href="/" className="btn btn-primary w-100">
Sign In
            </PhoenixLink>
          </div>
        </div>
