  ...
  return (
    ...
    <div className="row vh-100 g-0">
      <div className="col-lg-6 position-relative d-none d-lg-block">
        <div className="bg-holder" style={{"backgroundImage":"url(../../../assets/img/bg/31.png)"} as CSSProperties}>        </div>
      </div>
      <div className="col-lg-6">
        <div className="row flex-center h-100 g-0 px-4 px-sm-0">
          <div className="col col-sm-6 col-lg-7 col-xl-6">
            <div className="text-center mb-6 mx-auto">
              <PhoenixImage src="/assets/img/spot-illustrations/1.png" alt="phoenix" className="mb-7 d-dark-none" />
              <PhoenixImage src="/assets/img/spot-illustrations/dark_1.png" alt="phoenix" className="mb-7 d-light-none" />
              <div className="mb-6">
...
You are now successfully signed out.
              ...
              <div className="d-grid">
                <PhoenixLink href="/pages/authentication/split/sign-in" className="btn btn-primary">
