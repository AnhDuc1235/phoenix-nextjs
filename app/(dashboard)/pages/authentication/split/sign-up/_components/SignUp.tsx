  ...
  return (
    ...
    <div className="row vh-100 g-0">
      <div className="col-lg-6 position-relative d-none d-lg-block">
        <div className="bg-holder" style={{"backgroundImage":"url(../../../assets/img/bg/32.png)"} as CSSProperties}>        </div>
      </div>
...
Sign up
              ...
              <div className="text-center">
                <PhoenixLink href="/pages/authentication/split/sign-in" className="fs-9 fw-bold">
