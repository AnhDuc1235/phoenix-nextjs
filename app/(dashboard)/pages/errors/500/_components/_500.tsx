        ...
        <div className="col-12 col-xl-10 col-xxl-8">
          <div className="row justify-content-center g-5">
            <div className="col-12 col-lg-6 text-center order-lg-1">
              <PhoenixImage src="/assets/img/spot-illustrations/500-illustration.png" alt="" className="img-fluid w-lg-100 d-light-none" width={400} />
              <PhoenixImage src="/assets/img/spot-illustrations/dark_500-illustration.png" alt="" className="img-fluid w-md-50 w-lg-100 d-dark-none" width={540} />
            </div>
            <div className="col-12 col-lg-6 text-center text-lg-start">
              <PhoenixImage src="/assets/img/spot-illustrations/500.png" alt="" className="img-fluid mb-6 w-50 w-lg-75 d-dark-none" />
              <PhoenixImage src="/assets/img/spot-illustrations/dark_500.png" alt="" className="img-fluid mb-6 w-50 w-lg-75 d-light-none" />
