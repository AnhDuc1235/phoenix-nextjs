...
export default function FaqTab() {
  return (
    ...
    <div className="mb-9">
      <div className="mx-n4 mx-lg-n6 mt-n5 position-relative mb-md-9" style={{"height":"208px"} as CSSProperties}>
        <div className="bg-holder bg-card d-dark-none" style={{"backgroundImage":"url(../../assets/img/bg/bg-40.png)","backgroundSize":"cover"} as CSSProperties}>        </div>
        <div className="bg-holder bg-card d-light-none" style={{"backgroundImage":"url(../../assets/img/bg/bg-dark-40.png)","backgroundSize":"cover"} as CSSProperties}>        </div>
...
contact our support
      ...
      <div className="row gx-xl-8 gx-xxl-11 gy-6 faq">
        <div className="col-md-6 col-xl-5 col-xxl-4">
          <div className="faq-sidebar offcanvas offcanvas-start bg-body z-5 w-100" id="faq-offcanvas" data-bs-backdrop={"false"} data-vertical-category-offcanvas>
...
All Categories
            ...
            <div className="faq-subcategory-tab nav nav-tabs w-sm-75 w-md-100 mx-auto mb-4" id="faq-subcategory-tab" style={{"width":"90%"} as CSSProperties}>
              <div className="nav-item w-100 popular mb-3" role="presentation">
                <button className="category nav-link btn bg-body-emphasis w-100 px-3 pt-4 pb-3 fs-8 active" id="tab-sale-101" data-bs-toggle={"tab"} data-bs-target={"#sale-101"} type="button" role="tab" aria-selected="false" data-vertical-category-tab>
...
{"Answer the most frequently asked questions about your products & services here."}
              ...
              <div className="nav-item w-100  mb-3" role="presentation">
                <button className="category nav-link btn bg-body-emphasis w-100 px-3 pt-4 pb-3 fs-8" id="tab-delivery-101" data-bs-toggle={"tab"} data-bs-target={"#delivery-101"} type="button" role="tab" aria-selected="false" data-vertical-category-tab>
...
{"Answer each & every question about your product and service delivery, maintain customers."}
              ...
              <div className="nav-item w-100  mb-3" role="presentation">
                <button className="category nav-link btn bg-body-emphasis w-100 px-3 pt-4 pb-3 fs-8" id="tab-notification-101" data-bs-toggle={"tab"} data-bs-target={"#notification-101"} type="button" role="tab" aria-selected="false" data-vertical-category-tab>
...
Check and get all the necessary notices on the same page and board. Learn the FAQs here.
              ...
              <div className="nav-item w-100  mb-3" role="presentation">
                <button className="category nav-link btn bg-body-emphasis w-100 px-3 pt-4 pb-3 fs-8" id="tab-order-101" data-bs-toggle={"tab"} data-bs-target={"#order-101"} type="button" role="tab" aria-selected="false" data-vertical-category-tab>
...
Check and have all your product order FAQs answered here. 
              ...
              <div className="nav-item w-100  mb-3" role="presentation">
                <button className="category nav-link btn bg-body-emphasis w-100 px-3 pt-4 pb-3 fs-8" id="tab-networking-101" data-bs-toggle={"tab"} data-bs-target={"#networking-101"} type="button" role="tab" aria-selected="false" data-vertical-category-tab>
...
See and answer all the queries to help your clients and customers and build strong networking between your team and your clientele
              ...
              <div className="nav-item w-100 popular mb-3" role="presentation">
                <button className="category nav-link btn bg-body-emphasis w-100 px-3 pt-4 pb-3 fs-8" id="tab-customize-101" data-bs-toggle={"tab"} data-bs-target={"#customize-101"} type="button" role="tab" aria-selected="false" data-vertical-category-tab>
...
Answer customization related questions here for simple and easy assistance.
              ...
              <div className="nav-item w-100  mb-3" role="presentation">
                <button className="category nav-link btn bg-body-emphasis w-100 px-3 pt-4 pb-3 fs-8" id="tab-marketing-101" data-bs-toggle={"tab"} data-bs-target={"#marketing-101"} type="button" role="tab" aria-selected="false" data-vertical-category-tab>
...
Get all the marketing related questions answered here.
              ...
              <div className="nav-item w-100  mb-3" role="presentation">
                <button className="category nav-link btn bg-body-emphasis w-100 px-3 pt-4 pb-3 fs-8" id="tab-our-vision-101" data-bs-toggle={"tab"} data-bs-target={"#our-vision-101"} type="button" role="tab" aria-selected="false" data-vertical-category-tab>
...
We provide web development solution in an economically efficient way. Learn further from these FAQs here
              ...
              <div className="nav-item w-100  mb-0" role="presentation">
                <button className="category nav-link btn bg-body-emphasis w-100 px-3 pt-4 pb-3 fs-8" id="tab-scheduling-101" data-bs-toggle={"tab"} data-bs-target={"#scheduling-101"} type="button" role="tab" aria-selected="false" data-vertical-category-tab>
