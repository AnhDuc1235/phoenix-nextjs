          ...
          <div className="col-xl-6">
            <div className="d-flex justify-content-center mt-xl-15">
              <div className="text-container text-center text-xl-start">
                <PhoenixImage src="/assets/img/spot-illustrations/43.png" alt="" className="d-dark-none mb-7 w-75 w-lg-50 w-xl-75" />
                <PhoenixImage src="/assets/img/spot-illustrations/dark_43.png" alt="" className="d-light-none mb-7 w-75 w-lg-50 w-xl-75" />
                <h2 className="text-gray-800 fs-xl-6 mb-3">
This page is under development !
                </h2>
                <p className="mb-6">
We are working on it. Hopefully in the next one or two release cycles (in other words, very very soon 🎉 ), this page will be added. Let's go!
                </p>
