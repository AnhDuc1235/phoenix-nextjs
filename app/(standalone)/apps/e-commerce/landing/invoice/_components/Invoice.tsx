...
Invoice
          ...
          <div>
            <button className="btn btn-phoenix-secondary me-2">
              <span className="fa-solid fa-download me-sm-2">              </span>
              <span className="d-none d-sm-inline-block">
Download Invoice
              </span>
            </button>
            <button className="btn btn-phoenix-secondary">
              <span className="fa-solid fa-print me-sm-2">              </span>
              <span className="d-none d-sm-inline-block">
Print
              </span>
            </button>
        ...
        <div className="px-0">
          <div className="table-responsive scrollbar">
            <table className="table fs-9 text-body mb-0">
              <thead className="bg-body-secondary"><tr>
                  <th scope="col" style={{"width":"24px"} as CSSProperties}>                  </th>
                  <th scope="col" style={{"minWidth":"60px"} as CSSProperties}>
SL NO.
                  </th>
                  <th scope="col" style={{"minWidth":"360px"} as CSSProperties}>
Products
                  </th>
                  <th className="ps-5" scope="col" style={{"minWidth":"150px"} as CSSProperties}>
Color
                  </th>
                  <th scope="col" style={{"width":"60px"} as CSSProperties}>
Size
                  </th>
                  <th className="text-end" scope="col" style={{"width":"80px"} as CSSProperties}>
Quantity
                  </th>
                  <th className="text-end" scope="col" style={{"width":"100px"} as CSSProperties}>
Price
                  </th>
                  <th className="text-end" scope="col" style={{"width":"138px"} as CSSProperties}>
Tax Rate
                  </th>
                  <th className="text-center" scope="col" style={{"width":"80px"} as CSSProperties}>
Tax Type
                  </th>
                  <th className="text-end" scope="col" style={{"minWidth":"92px"} as CSSProperties}>
Tax
                  </th>
                  <th className="text-end" scope="col" style={{"minWidth":"60px"} as CSSProperties}>
Total
                  </th>
                  <th scope="col" style={{"width":"24px"} as CSSProperties}>                  </th>
                </tr>
...
PlayStation 5 DualSense Wireless Controller
                  ...
                  <td className="align-middle ps-5 border-0">
White
                  </td>
...
$185
                  ...
                  <td className="align-middle text-end border-0">
3.5%
                  </td>
...
$398
                ...
                <tr className="bg-body-secondary"><td>                  </td>
...
-$50
                ...
                <tr className="bg-body-secondary"><td className="align-middle ps-4 fw-bold text-body-highlight" colSpan={3}>
Grand Total
                  </td>
...
$398
          ...
          <div className="text-end py-9 border-bottom">
            <PhoenixImage src="/assets/img/logos/phoenix-mart.png" alt="" className="mb-3" />
            <h4>
...
Themewagon
        ...
        <div className="d-flex justify-content-between">
          <button className="btn btn-primary">
            <span className="fa-solid fa-bag-shopping me-2">            </span>
Browse more items
          </button>
          <div>
            <button className="btn btn-phoenix-secondary me-2">
