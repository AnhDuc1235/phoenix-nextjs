 ...
 10:30 AM
                    ...
                    <div className="timeline-item-bar position-relative me-3 me-md-0">
                      <div className="icon-item icon-item-sm bg-success" data-bs-theme={"light"}>
                        <span className="fa-solid fa-check text-white fs-10">                        </span>
                      </div>
                      <span className="timeline-bar border-end border-success">                      </span>
                    </div>
                  </div>
                  <div className="col">
...
25 August, 2023
 ...
 11:30 AM
                    ...
                    <div className="timeline-item-bar position-relative me-3 me-md-0">
                      ...
                      <span className="timeline-bar border-end border-warning">                      </span>
                    </div>
                  </div>
                  <div className="col">
                    <div className="timeline-item-content ps-6 ps-md-3">
...
27 August, 2023
 ...
 6:30 AM
                    ...
                    <div className="timeline-item-bar position-relative me-3 me-md-0">
                      <div className="icon-item icon-item-sm bg-warning" data-bs-theme={"light"}>
                        <span className="fa-solid fa-truck-ramp-box text-white fs-10">                        </span>
                      </div>
...
Estimated time
 ...
 29 August, 2023
                    ...
                    <div className="timeline-item-bar position-relative me-3 me-md-0">
                      <div className="icon-item icon-item-sm bg-body-quaternary" data-bs-theme={"light"}>
                        <span className="fa-solid fa-truck text-white fs-10">                        </span>
                      </div>
                      <span className="timeline-bar border-end border-dashed">                      </span>
                    </div>
                  </div>
...
Estimated time
 ...
 30 August, 2023
                    ...
                    <div className="timeline-item-bar position-relative me-3 me-md-0">
                      <div className="icon-item icon-item-sm bg-body-quaternary" data-bs-theme={"light"}>
                        <span className="fa-solid fa-truck-fast text-white fs-10">                        </span>
                      </div>
                    </div>
                  </div>
                  <div className="col">
