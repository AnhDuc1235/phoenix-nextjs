 ...
 More              <span className="fas fa-angle-down ms-2">              </span>
    ...
    <section className="pt-5 pb-9">
      <div className="product-filter-container">
        <button className="btn btn-sm btn-phoenix-secondary text-body-tertiary mb-5 d-lg-none" data-phoenix-toggle={"offcanvas"} data-phoenix-target={"#productFilterColumn"}>
          <span className="fa-solid fa-filter me-2">          </span>
Filter
        </button>
        <div className="row">
          <div className="col-lg-3 col-xxl-2 ps-2 ps-xxl-3">
            <div className="phoenix-offcanvas-filter bg-body scrollbar phoenix-offcanvas phoenix-offcanvas-fixed" id="productFilterColumn" style={{"top":"92px"} as CSSProperties} data-breakpoint={"lg"}>
              <div className="d-flex justify-content-between align-items-center mb-3">
                <h3 className="mb-0">
Filters
                </h3>
                <button className="btn d-lg-none p-0" data-phoenix-dismiss={"offcanvas"}>
                  <span className="uil uil-times fs-8">                  </span>
                </button>
              </div>
              <a href="#collapseAvailability" className="btn px-0 d-block collapse-indicator" data-bs-toggle={"collapse"}  role="button" aria-expanded="true" aria-controls="collapseAvailability">
                <div className="d-flex align-items-center justify-content-between w-100">
                  <div className="fs-8 text-body-highlight">
Availability
                  </div>
                  <span className="fa-solid fa-angle-down toggle-icon text-body-quaternary">                  </span>
                </div>
              </a>
              <div className="collapse show" id="collapseAvailability">
                <div className="mb-2">
                  <div className="form-check mb-0">
                    <input className="form-check-input mt-0" id="inStockInput" type="checkbox" name="color" defaultChecked />
                    <label className="form-check-label d-block lh-sm fs-8 text-body fw-normal mb-0" htmlFor="inStockInput">
In stock
                    </label>
                  </div>
                  <div className="form-check mb-0">
                    <input className="form-check-input mt-0" id="preBookInput" type="checkbox" name="color" />
                    <label className="form-check-label d-block lh-sm fs-8 text-body fw-normal mb-0" htmlFor="preBookInput">
Pre-book
                    </label>
                  </div>
                  <div className="form-check mb-0">
                    <input className="form-check-input mt-0" id="outOfStockInput" type="checkbox" name="color" />
                    <label className="form-check-label d-block lh-sm fs-8 text-body fw-normal mb-0" htmlFor="outOfStockInput">
Out of stock
                    </label>
                  </div>
                </div>
              </div>
              <a href="#collapseColorFamily" className="btn px-0 d-block collapse-indicator" data-bs-toggle={"collapse"}  role="button" aria-expanded="true" aria-controls="collapseColorFamily">
                <div className="d-flex align-items-center justify-content-between w-100">
                  <div className="fs-8 text-body-highlight">
Color family
                  </div>
              ...
              <div className="collapse show" id="collapseColorFamily">
                <div className="mb-2">
                  <div className="form-check mb-0">
                    <input className="form-check-input mt-0" id="flexCheckBlack" type="checkbox" name="color" defaultChecked />
                    <label className="form-check-label d-block lh-sm fs-8 text-body fw-normal mb-0" htmlFor="flexCheckBlack">
Black
                    </label>
                  </div>
                  <div className="form-check mb-0">
                    <input className="form-check-input mt-0" id="flexCheckBlue" type="checkbox" name="color" />
                    <label className="form-check-label d-block lh-sm fs-8 text-body fw-normal mb-0" htmlFor="flexCheckBlue">
Blue
                    </label>
                  </div>
                  <div className="form-check mb-0">
                    <input className="form-check-input mt-0" id="flexCheckRed" type="checkbox" name="color" />
                    <label className="form-check-label d-block lh-sm fs-8 text-body fw-normal mb-0" htmlFor="flexCheckRed">
Red
                    </label>
                  </div>
                </div>
              </div>
              <a href="#collapseBrands" className="btn px-0 d-block collapse-indicator" data-bs-toggle={"collapse"}  role="button" aria-expanded="true" aria-controls="collapseBrands">
                <div className="d-flex align-items-center justify-content-between w-100">
                  <div className="fs-8 text-body-highlight">
Brands
                  </div>
              ...
              <div className="collapse show" id="collapseBrands">
                <div className="mb-2">
                  <div className="form-check mb-0">
                    <input className="form-check-input mt-0" id="flexCheckBlackberry" type="checkbox" name="brands" defaultChecked />
                    <label className="form-check-label d-block lh-sm fs-8 text-body fw-normal mb-0" htmlFor="flexCheckBlackberry">
 Blackberry 
                    </label>
                  </div>
                  <div className="form-check mb-0">
                    <input className="form-check-input mt-0" id="flexCheckApple" type="checkbox" name="brands" />
                    <label className="form-check-label d-block lh-sm fs-8 text-body fw-normal mb-0" htmlFor="flexCheckApple">
 Apple 
                    </label>
                  </div>
                  <div className="form-check mb-0">
                    <input className="form-check-input mt-0" id="flexCheckNokia" type="checkbox" name="brands" />
                    <label className="form-check-label d-block lh-sm fs-8 text-body fw-normal mb-0" htmlFor="flexCheckNokia">
 Nokia 
                    </label>
                  </div>
                  <div className="form-check mb-0">
                    <input className="form-check-input mt-0" id="flexCheckSony" type="checkbox" name="brands" />
                    <label className="form-check-label d-block lh-sm fs-8 text-body fw-normal mb-0" htmlFor="flexCheckSony">
 Sony 
                    </label>
                  </div>
                  <div className="form-check mb-0">
                    <input className="form-check-input mt-0" id="flexCheckLG" type="checkbox" name="brands" />
                    <label className="form-check-label d-block lh-sm fs-8 text-body mb-0 fw-normal" htmlFor="flexCheckLG">
 LG 
                    </label>
                  </div>
                </div>
              </div>
              <a href="#collapsePriceRange" className="btn px-0 d-block collapse-indicator" data-bs-toggle={"collapse"}  role="button" aria-expanded="true" aria-controls="collapsePriceRange">
                <div className="d-flex align-items-center justify-content-between w-100">
                  <div className="fs-8 text-body-highlight">
Price range
                  </div>
              ...
              <div className="collapse show" id="collapsePriceRange">
                <div className="d-flex justify-content-between mb-3">
                  <div className="input-group me-2">
                    <input className="form-control" type="text" aria-label="First name" placeholder="Min" />
                    <input className="form-control" type="text" aria-label="Last name" placeholder="Max" />
                  </div>
...
Go
              ...
              <a href="#collapseRating" className="btn px-0 y-4 d-block collapse-indicator" data-bs-toggle={"collapse"}  role="button" aria-expanded="true" aria-controls="collapseRating">
                <div className="d-flex align-items-center justify-content-between w-100">
                  <div className="fs-8 text-body-highlight">
Rating
                  </div>
              ...
              <div className="collapse show" id="collapseRating">
                <div className="d-flex align-items-center mb-1">
                  <input className="form-check-input me-3" id="flexRadio1" type="radio" name="flexRadio" />
                  <span className="fa fa-star text-warning fs-9 me-1">                  </span>
                  <span className="fa fa-star text-warning fs-9 me-1">                  </span>
                  <span className="fa fa-star text-warning fs-9 me-1">                  </span>
                  <span className="fa fa-star text-warning fs-9 me-1">                  </span>
                  <span className="fa fa-star text-warning fs-9 me-1">                  </span>
                ...
                <div className="d-flex align-items-center mb-1">
                  <input className="form-check-input me-3" id="flexRadio2" type="radio" name="flexRadio" />
                  <span className="fa fa-star text-warning fs-9 me-1">                  </span>
                  <span className="fa fa-star text-warning fs-9 me-1">                  </span>
                  <span className="fa fa-star text-warning fs-9 me-1">                  </span>
                  <span className="fa fa-star text-warning fs-9 me-1">                  </span>
                  <span className="fa-regular fa-star text-warning-light fs-9 me-1" data-bs-theme={"light"}>                  </span>
                  <p className="ms-1 mb-0">
{"& above"}
                  </p>
                </div>
                <div className="d-flex align-items-center mb-1">
                  <input className="form-check-input me-3" id="flexRadio3" type="radio" name="flexRadio" />
                  <span className="fa fa-star text-warning fs-9 me-1">                  </span>
                  <span className="fa fa-star text-warning fs-9 me-1">                  </span>
                  <span className="fa fa-star text-warning fs-9 me-1">                  </span>
                  <span className="fa-regular fa-star text-warning-light fs-9 me-1" data-bs-theme={"light"}>                  </span>
...
{"& above "}
                ...
                <div className="d-flex align-items-center mb-1">
                  <input className="form-check-input me-3" id="flexRadio4" type="radio" name="flexRadio" />
                  <span className="fa fa-star text-warning fs-9 me-1">                  </span>
                  <span className="fa fa-star text-warning fs-9 me-1">                  </span>
                  <span className="fa-regular fa-star text-warning-light fs-9 me-1" data-bs-theme={"light"}>                  </span>
                  <span className="fa-regular fa-star text-warning-light fs-9 me-1" data-bs-theme={"light"}>                  </span>
...
{"& above"}
                ...
                <div className="d-flex align-items-center mb-3">
                  <input className="form-check-input me-3" id="flexRadio5" type="radio" name="flexRadio" />
                  <span className="fa fa-star text-warning fs-9 me-1">                  </span>
                  <span className="fa-regular fa-star text-warning-light fs-9 me-1" data-bs-theme={"light"}>                  </span>
                  <span className="fa-regular fa-star text-warning-light fs-9 me-1" data-bs-theme={"light"}>                  </span>
                  <span className="fa-regular fa-star text-warning-light fs-9 me-1" data-bs-theme={"light"}>                  </span>
...
{"& above "}
              ...
              <a href="#collapseDisplayType" className="btn px-0 d-block collapse-indicator" data-bs-toggle={"collapse"}  role="button" aria-expanded="true" aria-controls="collapseDisplayType">
                <div className="d-flex align-items-center justify-content-between w-100">
                  <div className="fs-8 text-body-highlight">
Display type
                  </div>
              ...
              <div className="collapse show" id="collapseDisplayType">
                <div className="mb-2">
                  <div className="form-check mb-0">
                    <input className="form-check-input mt-0" id="lcdInput" type="checkbox" name="displayType" defaultChecked />
                    <label className="form-check-label d-block lh-sm fs-8 text-body fw-normal mb-0" htmlFor="lcdInput">
LCD
                    </label>
                  </div>
                  <div className="form-check mb-0">
                    <input className="form-check-input mt-0" id="ipsInput" type="checkbox" name="displayType" />
                    <label className="form-check-label d-block lh-sm fs-8 text-body fw-normal mb-0" htmlFor="ipsInput">
IPS
                    </label>
                  </div>
                  <div className="form-check mb-0">
                    <input className="form-check-input mt-0" id="oledInput" type="checkbox" name="displayType" />
                    <label className="form-check-label d-block lh-sm fs-8 text-body fw-normal mb-0" htmlFor="oledInput">
OLED
                    </label>
                  </div>
                  <div className="form-check mb-0">
                    <input className="form-check-input mt-0" id="amoledInput" type="checkbox" name="displayType" />
                    <label className="form-check-label d-block lh-sm fs-8 text-body fw-normal mb-0" htmlFor="amoledInput">
AMOLED
                    </label>
                  </div>
                  <div className="form-check mb-0">
                    <input className="form-check-input mt-0" id="retinaInput" type="checkbox" name="displayType" />
                    <label className="form-check-label d-block lh-sm fs-8 text-body fw-normal mb-0" htmlFor="retinaInput">
Retina
                    </label>
                  </div>
                </div>
              </div>
              <a href="#collapseCondition" className="btn px-0 d-block collapse-indicator" data-bs-toggle={"collapse"}  role="button" aria-expanded="true" aria-controls="collapseCondition">
                <div className="d-flex align-items-center justify-content-between w-100">
                  <div className="fs-8 text-body-highlight">
Condition
                  </div>
              ...
              <div className="collapse show" id="collapseCondition">
                <div className="mb-2">
                  <div className="form-check mb-0">
                    <input className="form-check-input mt-0" id="newInput" type="checkbox" name="condition" defaultChecked />
                    <label className="form-check-label d-block lh-sm fs-8 text-body fw-normal mb-0" htmlFor="newInput">
New
                    </label>
                  </div>
                  <div className="form-check mb-0">
                    <input className="form-check-input mt-0" id="usedInput" type="checkbox" name="condition" />
                    <label className="form-check-label d-block lh-sm fs-8 text-body fw-normal mb-0" htmlFor="usedInput">
Used
                    </label>
                  </div>
                  <div className="form-check mb-0">
                    <input className="form-check-input mt-0" id="refurbrishedInput" type="checkbox" name="condition" />
                    <label className="form-check-label d-block lh-sm fs-8 text-body fw-normal mb-0" htmlFor="refurbrishedInput">
Refurbrished
                    </label>
                  </div>
                </div>
              </div>
              <a href="#collapseDelivery" className="btn px-0 d-block collapse-indicator" data-bs-toggle={"collapse"}  role="button" aria-expanded="true" aria-controls="collapseDelivery">
                <div className="d-flex align-items-center justify-content-between w-100">
                  <div className="fs-8 text-body-highlight">
Delivery
                  </div>
              ...
              <div className="collapse show" id="collapseDelivery">
                <div className="mb-2">
                  <div className="form-check mb-0">
                    <input className="form-check-input mt-0" id="freeShippingInput" type="checkbox" name="delivery" defaultChecked />
                    <label className="form-check-label d-block lh-sm fs-8 text-body fw-normal mb-0" htmlFor="freeShippingInput">
Free Shipping
                    </label>
                  </div>
                  <div className="form-check mb-0">
                    <input className="form-check-input mt-0" id="oneDayShippingInput" type="checkbox" name="delivery" />
                    <label className="form-check-label d-block lh-sm fs-8 text-body fw-normal mb-0" htmlFor="oneDayShippingInput">
One-day Shipping
                    </label>
                  </div>
                  <div className="form-check mb-0">
                    <input className="form-check-input mt-0" id="codInput" type="checkbox" name="delivery" />
                    <label className="form-check-label d-block lh-sm fs-8 text-body fw-normal mb-0" htmlFor="codInput">
Cash on Delivery
                    </label>
                  </div>
                </div>
              </div>
              <a href="#collapseCampaign" className="btn px-0 d-block collapse-indicator" data-bs-toggle={"collapse"}  role="button" aria-expanded="true" aria-controls="collapseCampaign">
                <div className="d-flex align-items-center justify-content-between w-100">
                  <div className="fs-8 text-body-highlight">
Campaign
                  </div>
              ...
              <div className="collapse show" id="collapseCampaign">
                <div className="mb-2">
                  <div className="form-check mb-0">
                    <input className="form-check-input mt-0" id="summerSaleInput" type="checkbox" name="campaign" />
                    <label className="form-check-label d-block lh-sm fs-8 text-body fw-normal mb-0" htmlFor="summerSaleInput">
Summer Sale
                    </label>
                  </div>
                  <div className="form-check mb-0">
                    <input className="form-check-input mt-0" id="marchMadnessInput" type="checkbox" name="campaign" />
                    <label className="form-check-label d-block lh-sm fs-8 text-body fw-normal mb-0" htmlFor="marchMadnessInput">
March Madness
                    </label>
                  </div>
                  <div className="form-check mb-0">
                    <input className="form-check-input mt-0" id="flashSaleInput" type="checkbox" name="campaign" />
                    <label className="form-check-label d-block lh-sm fs-8 text-body fw-normal mb-0" htmlFor="flashSaleInput">
Flash Sale
                    </label>
                  </div>
                  <div className="form-check mb-0">
                    <input className="form-check-input mt-0" id="bogoBlastInput" type="checkbox" name="campaign" />
                    <label className="form-check-label d-block lh-sm fs-8 text-body fw-normal mb-0" htmlFor="bogoBlastInput">
BOGO Blast
                    </label>
                  </div>
                </div>
              </div>
              <a href="#collapseWarranty" className="btn px-0 d-block collapse-indicator" data-bs-toggle={"collapse"}  role="button" aria-expanded="true" aria-controls="collapseWarranty">
                <div className="d-flex align-items-center justify-content-between w-100">
                  <div className="fs-8 text-body-highlight">
Warranty
                  </div>
              ...
              <div className="collapse show" id="collapseWarranty">
                <div className="mb-2">
                  <div className="form-check mb-0">
                    <input className="form-check-input mt-0" id="threeMonthInput" type="checkbox" name="warranty" />
                    <label className="form-check-label d-block lh-sm fs-8 text-body fw-normal mb-0" htmlFor="threeMonthInput">
3 months
                    </label>
                  </div>
                  <div className="form-check mb-0">
                    <input className="form-check-input mt-0" id="sixMonthInput" type="checkbox" name="warranty" />
                    <label className="form-check-label d-block lh-sm fs-8 text-body fw-normal mb-0" htmlFor="sixMonthInput">
6 months
                    </label>
                  </div>
                  <div className="form-check mb-0">
                    <input className="form-check-input mt-0" id="oneYearInput" type="checkbox" name="warranty" />
                    <label className="form-check-label d-block lh-sm fs-8 text-body fw-normal mb-0" htmlFor="oneYearInput">
1 year
                    </label>
                  </div>
                  <div className="form-check mb-0">
                    <input className="form-check-input mt-0" id="twoYearsInput" type="checkbox" name="warranty" />
                    <label className="form-check-label d-block lh-sm fs-8 text-body fw-normal mb-0" htmlFor="twoYearsInput">
2 years
                    </label>
                  </div>
                  <div className="form-check mb-0">
                    <input className="form-check-input mt-0" id="threeYearsInput" type="checkbox" name="warranty" />
                    <label className="form-check-label d-block lh-sm fs-8 text-body fw-normal mb-0" htmlFor="threeYearsInput">
3 years
                    </label>
                  </div>
                  <div className="form-check mb-0">
                    <input className="form-check-input mt-0" id="fiveYearsInput" type="checkbox" name="warranty" />
                    <label className="form-check-label d-block lh-sm fs-8 text-body fw-normal mb-0" htmlFor="fiveYearsInput">
5 years
                    </label>
                  </div>
                </div>
              </div>
              <a href="#collapseWarrantyType" className="btn px-0 d-block collapse-indicator" data-bs-toggle={"collapse"}  role="button" aria-expanded="true" aria-controls="collapseWarrantyType">
                <div className="d-flex align-items-center justify-content-between w-100">
                  <div className="fs-8 text-body-highlight">
Warranty Type
                  </div>
              ...
              <div className="collapse show" id="collapseWarrantyType">
                <div className="mb-2">
                  <div className="form-check mb-0x">
                    <input className="form-check-input mt-0" id="replacementInput" type="checkbox" name="warrantyType" />
                    <label className="form-check-label d-block lh-sm fs-8 text-body fw-normal mb-0" htmlFor="replacementInput">
Replacement
                    </label>
                  </div>
                  <div className="form-check mb-0">
                    <input className="form-check-input mt-0" id="serviceInput" type="checkbox" name="warrantyType" />
                    <label className="form-check-label d-block lh-sm fs-8 text-body fw-normal mb-0" htmlFor="serviceInput">
Service
                    </label>
                  </div>
                  <div className="form-check mb-0">
                    <input className="form-check-input mt-0" id="partialCoveregeInput" type="checkbox" name="warrantyType" />
                    <label className="form-check-label d-block lh-sm fs-8 text-body fw-normal mb-0" htmlFor="partialCoveregeInput">
Partial Coverage
                    </label>
                  </div>
                  <div className="form-check mb-0">
                    <input className="form-check-input mt-0" id="appleCareInput" type="checkbox" name="warrantyType" />
                    <label className="form-check-label d-block lh-sm fs-8 text-body fw-normal mb-0" htmlFor="appleCareInput">
Apple Care
                    </label>
                  </div>
                  <div className="form-check mb-0">
                    <input className="form-check-input mt-0" id="moneyBackInput" type="checkbox" name="warrantyType" />
                    <label className="form-check-label d-block lh-sm fs-8 text-body fw-normal mb-0" htmlFor="moneyBackInput">
Money back
                    </label>
                  </div>
                  <div className="form-check mb-0">
                    <input className="form-check-input mt-0" id="extendableInput" type="checkbox" name="warrantyType" />
                    <label className="form-check-label d-block lh-sm fs-8 text-body fw-normal mb-0" htmlFor="extendableInput">
Extendable
                    </label>
                  </div>
                </div>
              </div>
              <a href="#collapseCertification" className="btn px-0 d-block collapse-indicator" data-bs-toggle={"collapse"}  role="button" aria-expanded="true" aria-controls="collapseCertification">
                <div className="d-flex align-items-center justify-content-between w-100">
                  <div className="fs-8 text-body-highlight">
Certification
                  </div>
              ...
              <div className="collapse show" id="collapseCertification">
                <div>
                  <div className="form-check mb-0">
                    <input className="form-check-input mt-0" id="rohsInput" type="checkbox" name="certification" />
                    <label className="form-check-label d-block lh-sm fs-8 text-body fw-normal mb-0" htmlFor="rohsInput">
RoHS
                    </label>
                  </div>
                  <div className="form-check mb-0">
                    <input className="form-check-input mt-0" id="fccInput" type="checkbox" name="certification" />
                    <label className="form-check-label d-block lh-sm fs-8 text-body fw-normal mb-0" htmlFor="fccInput">
FCC
                    </label>
                  </div>
                  <div className="form-check mb-0">
                    <input className="form-check-input mt-0" id="conflictInput" type="checkbox" name="certification" />
                    <label className="form-check-label d-block lh-sm fs-8 text-body fw-normal mb-0" htmlFor="conflictInput">
Conflict Free
                    </label>
                  </div>
                  <div className="form-check mb-0">
                    <input className="form-check-input mt-0" id="isoOneInput" type="checkbox" name="certification" />
                    <label className="form-check-label d-block lh-sm fs-8 text-body fw-normal mb-0" htmlFor="isoOneInput">
ISO 9001:2015
                    </label>
                  </div>
                  <div className="form-check mb-0">
                    <input className="form-check-input mt-0" id="isoTwoInput" type="checkbox" name="certification" />
                    <label className="form-check-label d-block lh-sm fs-8 text-body fw-normal mb-0" htmlFor="isoTwoInput">
ISO 27001:2013
                    </label>
                  </div>
                  <div className="form-check mb-0">
                    <input className="form-check-input mt-0" id="isoThreeInput" type="checkbox" name="certification" />
                    <label className="form-check-label d-block lh-sm fs-8 text-body fw-normal mb-0" htmlFor="isoThreeInput">
IEC 61000-4-2
                    </label>
                  </div>
                </div>
            ...
            <div className="phoenix-offcanvas-backdrop d-lg-none" data-phoenix-backdrop style={{"top":"92px"} as CSSProperties}>            </div>
          </div>
                    ...
                    <div className="d-flex flex-column justify-content-between h-100">
                      <div>
                        <div className="border border-1 border-translucent rounded-3 position-relative mb-3">
                          ...
                          <PhoenixImage src="/assets/img/products/20.png" alt="" className="img-fluid" />
                        </div>
                        <PhoenixLink href="/apps/e-commerce/landing/product-details" className="stretched-link">
                          <h6 className="mb-2 lh-sm line-clamp-3 product-name">
