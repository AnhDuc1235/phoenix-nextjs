            ...
            <div className="col-4">
              ...
              <label className="btn d-inline-block btn-navbar-style fs-9" htmlFor="themeSwitcherLight">
                <span className="mb-2 rounded d-block">
                  <PhoenixImage src="/assets/img/generic/default-light.png" alt="" className="img-fluid img-prototype mb-0" />
                </span>
...
Light
            ...
            <div className="col-4">
              ...
              <label className="btn d-inline-block btn-navbar-style fs-9" htmlFor="themeSwitcherDark">
                <span className="mb-2 rounded d-block">
                  <PhoenixImage src="/assets/img/generic/default-dark.png" alt="" className="img-fluid img-prototype mb-0" />
                </span>
                <span className="label-text">
 Dark
                </span>
            ...
            <div className="col-4">
              ...
              <label className="btn d-inline-block btn-navbar-style fs-9" htmlFor="themeSwitcherAuto">
                <span className="mb-2 rounded d-block">
                  <PhoenixImage src="/assets/img/generic/auto.png" alt="" className="img-fluid img-prototype mb-0" />
                </span>
                <span className="label-text">
 Auto
                </span>
...
Navigation Type
          ...
          <div className="row gx-2">
            <div className="col-6">
              <input className="btn-check" id="navbarPositionVertical" name="navigation-type" type="radio" defaultValue="vertical" data-theme-control={"phoenixNavbarPosition"} data-page-url={"documentation/layouts/vertical-navbar.html"} />
              <label className="btn d-inline-block btn-navbar-style fs-9" htmlFor="navbarPositionVertical">
                <span className="rounded d-block">
                  <PhoenixImage src="/assets/img/generic/default-light.png" alt="" className="img-fluid img-prototype d-dark-none" />
                  <PhoenixImage src="/assets/img/generic/default-dark.png" alt="" className="img-fluid img-prototype d-light-none" />
                </span>
                <span className="label-text">
Vertical
                </span>
            ...
            <div className="col-6">
              <input className="btn-check" id="navbarPositionHorizontal" name="navigation-type" type="radio" defaultValue="horizontal" data-theme-control={"phoenixNavbarPosition"} data-page-url={"documentation/layouts/horizontal-navbar.html"} />
              <label className="btn d-inline-block btn-navbar-style fs-9" htmlFor="navbarPositionHorizontal">
                <span className="rounded d-block">
                  <PhoenixImage src="/assets/img/generic/top-default.png" alt="" className="img-fluid img-prototype d-dark-none" />
                  <PhoenixImage src="/assets/img/generic/top-default-dark.png" alt="" className="img-fluid img-prototype d-light-none" />
                </span>
                <span className="label-text">
 Horizontal
                </span>
            ...
            <div className="col-6">
              <input className="btn-check" id="navbarPositionCombo" name="navigation-type" type="radio" defaultValue="combo" data-theme-control={"phoenixNavbarPosition"} data-page-url={"documentation/layouts/combo-navbar.html"} />
              <label className="btn d-inline-block btn-navbar-style fs-9" htmlFor="navbarPositionCombo">
                <span className="rounded d-block">
                  <PhoenixImage src="/assets/img/generic/nav-combo-light.png" alt="" className="img-fluid img-prototype d-dark-none" />
                  <PhoenixImage src="/assets/img/generic/nav-combo-dark.png" alt="" className="img-fluid img-prototype d-light-none" />
                </span>
                <span className="label-text">
 Combo
                </span>
            ...
            <div className="col-6">
              <input className="btn-check" id="navbarPositionTopDouble" name="navigation-type" type="radio" defaultValue="dual-nav" data-theme-control={"phoenixNavbarPosition"} data-page-url={"documentation/layouts/dual-nav.html"} />
              <label className="btn d-inline-block btn-navbar-style fs-9" htmlFor="navbarPositionTopDouble">
                <span className="rounded d-block">
                  <PhoenixImage src="/assets/img/generic/dual-light.png" alt="" className="img-fluid img-prototype d-dark-none" />
                  <PhoenixImage src="/assets/img/generic/dual-dark.png" alt="" className="img-fluid img-prototype d-light-none" />
                </span>
                <span className="label-text">
 Dual nav
                </span>
...
Default
            ...
            <div className="col-6">
              ...
              <label className="btn d-block w-100 btn-navbar-style fs-9" htmlFor="navbar-style-dark">
                <PhoenixImage src="/assets/img/generic/vertical-darker.png" alt="" className="img-fluid img-prototype d-dark-none" />
                <PhoenixImage src="/assets/img/generic/vertical-lighter.png" alt="" className="img-fluid img-prototype d-light-none" />
                <span className="label-text d-dark-none">
 Darker
                </span>
                <span className="label-text d-light-none">
...
Horizontal Navbar Shape
          ...
          <div className="row gx-2">
            <div className="col-6">
              <input className="btn-check" id="navbarShapeDefault" name="navbar-shape" type="radio" defaultValue="default" data-theme-control={"phoenixNavbarTopShape"} data-page-url={"documentation/layouts/horizontal-navbar.html"} />
              <label className="btn d-inline-block btn-navbar-style fs-9" htmlFor="navbarShapeDefault">
                <span className="mb-2 rounded d-block">
                  <PhoenixImage src="/assets/img/generic/top-default.png" alt="" className="img-fluid img-prototype d-dark-none mb-0" />
                  <PhoenixImage src="/assets/img/generic/top-default-dark.png" alt="" className="img-fluid img-prototype d-light-none mb-0" />
                </span>
                <span className="label-text">
Default
                </span>
            ...
            <div className="col-6">
              <input className="btn-check" id="navbarShapeSlim" name="navbar-shape" type="radio" defaultValue="slim" data-theme-control={"phoenixNavbarTopShape"} data-page-url={"documentation/layouts/horizontal-navbar.html#horizontal-navbar-slim"} />
              <label className="btn d-inline-block btn-navbar-style fs-9" htmlFor="navbarShapeSlim">
                <span className="mb-2 rounded d-block">
                  <PhoenixImage src="/assets/img/generic/top-slim.png" alt="" className="img-fluid img-prototype d-dark-none mb-0" />
                  <PhoenixImage src="/assets/img/generic/top-slim-dark.png" alt="" className="img-fluid img-prototype d-light-none mb-0" />
                </span>
                <span className="label-text">
 Slim
                </span>
          ...
          <div className="row gx-2">
            <div className="col-6">
              ...
              <label className="btn d-inline-block btn-navbar-style fs-9" htmlFor="navbarTopDefault">
                <span className="mb-2 rounded d-block">
                  <PhoenixImage src="/assets/img/generic/top-default.png" alt="" className="img-fluid img-prototype d-dark-none mb-0" />
                  <PhoenixImage src="/assets/img/generic/top-style-darker.png" alt="" className="img-fluid img-prototype d-light-none mb-0" />
                </span>
                <span className="label-text">
Default
                </span>
            ...
            <div className="col-6">
              ...
              <label className="btn d-inline-block btn-navbar-style fs-9" htmlFor="navbarTopDarker">
                <span className="mb-2 rounded d-block">
                  <PhoenixImage src="/assets/img/generic/navbar-top-style-light.png" alt="" className="img-fluid img-prototype d-dark-none mb-0" />
                  <PhoenixImage src="/assets/img/generic/top-style-lighter.png" alt="" className="img-fluid img-prototype d-light-none mb-0" />
                </span>
                <span className="label-text d-dark-none">
Darker
                </span>
...
Lighter
        ...
        <a href="https://themes.getbootstrap.com/product/phoenix-admin-dashboard-webapp-template/" className="bun btn-primary d-grid mb-3 text-white mt-5 btn btn-primary"  target="_blank">
Purchase template
        </a>
      </div>
    </div>
    <a href="#settings-offcanvas" className="card setting-toggle"  data-bs-toggle={"offcanvas"}>
      <div className="card-body d-flex align-items-center px-2 py-1">
        <div className="position-relative rounded-start" style={{"height":"34px","width":"28px"} as CSSProperties}>
